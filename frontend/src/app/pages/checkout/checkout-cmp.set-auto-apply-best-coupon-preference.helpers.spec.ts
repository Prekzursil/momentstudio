...
/** Golden WU checkout-cmp-set-auto-apply-best-coupon-preference -- setAutoApplyBestCouponPreference. */
describe('CheckoutComponent setAutoApplyBestCouponPreference (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setAutoApplyBestCouponPreference(false); }).not.toThrow();
  });
});
