...
/** Golden WU admin-cmp-delete-category-translation -- deleteCategoryTranslation. */
describe('AdminComponent deleteCategoryTranslation (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteCategoryTranslation(undefined as any); }).not.toThrow();
  });
});
