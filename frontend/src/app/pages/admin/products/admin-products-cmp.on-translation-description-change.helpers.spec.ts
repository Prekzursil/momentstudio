...
/** Golden WU admin-products-cmp-on-translation-description-change -- onTranslationDescriptionChange. */
describe('AdminProductsComponent onTranslationDescriptionChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onTranslationDescriptionChange(undefined as any); }).not.toThrow();
  });
});
