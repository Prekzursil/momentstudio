    ...
    : [
        {
          ...
          loadComponent: () =>
            import('./pages/checkout/paypal-mock.component').then((m) => m.PayPalMockComponent),
        ...
        },
        {
          ...
          loadComponent: () =>
            import('./pages/checkout/stripe-mock.component').then((m) => m.StripeMockComponent),
...
export const routes: Routes = [
  ...
  ...mockCheckoutRoutes,
  {
    ...
    loadComponent: () =>
      import('./pages/checkout/paypal-return.component').then((m) => m.PayPalReturnComponent),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/checkout/stripe-return.component').then((m) => m.StripeReturnComponent),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/checkout/netopia-return.component').then((m) => m.NetopiaReturnComponent),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/checkout/paypal-cancel.component').then((m) => m.PayPalCancelComponent),
    title: 'meta.titles.checkout',
    data: { robots: NOINDEX_ROBOTS },
  },
  {
    ...
    loadComponent: () =>
      import('./pages/checkout/stripe-cancel.component').then((m) => m.StripeCancelComponent),
    title: 'meta.titles.checkout',
    data: { robots: NOINDEX_ROBOTS },
  },
  {
    ...
    loadComponent: () =>
      import('./pages/checkout/netopia-cancel.component').then((m) => m.NetopiaCancelComponent),
    title: 'meta.titles.checkout',
    data: { robots: NOINDEX_ROBOTS },
  },
  {
    ...
    loadComponent: () =>
      import('./pages/checkout/success.component').then((m) => m.SuccessComponent),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/auth/google-callback.component').then((m) => m.GoogleCallbackComponent),
  ...
  },
  {
    path: 'password-reset',
    loadComponent: () =>
      import('./pages/auth/password-reset-request.component').then(
  ...
  },
  {
    path: 'verify-email',
    loadComponent: () =>
      import('./pages/auth/verify-email.component').then((m) => m.VerifyEmailComponent),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/newsletter/newsletter-confirm.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/newsletter/newsletter-unsubscribe.component').then(
    ...
    children: [
      {
        path: '',
        loadComponent: () =>
          import('./pages/account/account-overview.component').then(
      ...
      },
      {
        path: 'addresses',
        loadComponent: () =>
          import('./pages/account/account-addresses.component').then(
      ...
      },
      {
        path: 'wishlist',
        loadComponent: () =>
          import('./pages/account/account-wishlist.component').then(
      ...
      },
      {
        path: 'coupons',
        loadComponent: () =>
          import('./pages/account/account-coupons.component').then(
            (m) => m.AccountCouponsComponent,
          ),
      },
      {
        path: 'notifications',
        loadComponent: () =>
          import('./pages/account/account-notifications-inbox.component').then(
            (m) => m.AccountNotificationsInboxComponent,
          ),
      },
      {
        path: 'notifications/settings',
        loadComponent: () =>
          import('./pages/account/account-notifications.component').then(
      ...
      },
      {
        path: 'comments',
        loadComponent: () =>
          import('./pages/account/account-comments.component').then(
      ...
      },
      {
        path: 'privacy',
        loadComponent: () =>
          import('./pages/account/account-privacy.component').then(
      ...
      },
      {
        path: 'password',
        loadComponent: () =>
          import('./pages/account/change-password.component').then(
  ...
  },
  {
    ...
    children: [
      { path: '', pathMatch: 'full', redirectTo: 'dashboard' },
      {
        path: 'ip-bypass',
        loadComponent: () =>
          import('./pages/admin/ip-bypass/admin-ip-bypass.component').then(
            (m) => m.AdminIpBypassComponent,
          ),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/admin/content/admin-content-layout.component').then(
            (m) => m.AdminContentLayoutComponent,
          ),
        children: [
          ...
          },
          {
            path: 'scheduling',
            loadComponent: () =>
              import('./pages/admin/content/admin-content-scheduling.component').then(
                (m) => m.AdminContentSchedulingComponent,
              ),
          ...
          },
          {
            path: 'media',
            loadComponent: () =>
              import('./pages/admin/content/admin-content-media.component').then(
                (m) => m.AdminContentMediaComponent,
              ),
      ...
      },
      {
        path: 'orders/exports',
        loadComponent: () =>
          import('./pages/admin/orders/admin-order-exports.component').then(
            (m) => m.AdminOrderExportsComponent,
          ),
        canActivate: [adminSectionGuard('orders')],
      ...
      },
      {
        path: 'orders/:orderId',
        loadComponent: () =>
          import('./pages/admin/orders/admin-order-detail.component').then(
      ...
      },
      {
        path: 'returns',
        loadComponent: () =>
          import('./pages/admin/returns/admin-returns.component').then(
      ...
      },
      {
        path: 'coupons',
        loadComponent: () =>
          import('./pages/admin/coupons/admin-coupons.component').then(
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'gdpr',
            loadComponent: () =>
              import('./pages/admin/users/admin-gdpr.component').then((m) => m.AdminGdprComponent),
            title: 'meta.titles.admin_gdpr',
          },
          {
            path: 'segments',
            loadComponent: () =>
              import('./pages/admin/users/admin-segments.component').then(
                (m) => m.AdminSegmentsComponent,
              ),
      ...
      },
      {
        path: 'support',
        loadComponent: () =>
          import('./pages/admin/support/admin-support.component').then(
      ...
      },
      {
        path: 'ops',
        loadComponent: () =>
          import('./pages/admin/ops/admin-ops.component').then((m) => m.AdminOpsComponent),
