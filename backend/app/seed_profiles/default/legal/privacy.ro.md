Prezenta Politică de Confidențialitate explică modul în care IONITA M.D. ADRIANA PFA („noi”, „al nostru”) colectează, utilizează și divulgă date cu caracter personal atunci când vizitezi momentstudio.ro sau cumperi produse de la noi.

Scopul documentului este informarea transparentă și explicarea drepturilor tale conform legislației de protecție a datelor (inclusiv GDPR).

---

## 1) Operatorul de date & contact
...
- adresă de e-mail,
- număr de telefon,
- identificatori de autentificare și credențiale criptate,
...
1. **Crearea și administrarea contului** (executarea contractului / interes legitim).
2. **Procesarea comenzilor și livrarea produselor** (executarea contractului).
3. **Plăți și prevenirea fraudelor** (executarea contractului, obligații legale, interes legitim).
4. **Suport clienți, reclamații** (executarea contractului, interes legitim, obligații legale).
5. **Contabilitate și fiscalitate** (obligații legale).
6. **Securitatea Site‑ului** (interes legitim).
7. **Marketing** (doar cu consimțământ sau dacă legea permite).
...
Divulgăm datele doar atunci când este necesar, de exemplu către:

- **Procesatori de plăți:** NETOPIA Payments și/sau alți procesatori activați (PayPal/Stripe) – procesare și confirmare plată.
- **Curieri / furnizori livrare:** Sameday/FanCourier – pentru expedierea comenzii (nume, telefon, adresă).
- **Furnizori e-mail/SMS:** Mailtrap – mesaje tranzacționale (confirmări, update-uri).
- **Hosting / infrastructură:** chroot.ro – găzduirea Site‑ului și a bazelor de date.
- **Securitate / anti-bot:** Cloudflare Turnstile (dacă e activ pe autentificare/înregistrare) – prevenirea abuzurilor.
...
- **loguri securitate:** până la ștergerea contului sau solicitarea ștergerii lor.
...
Niciun sistem online nu este 100% sigur; contactează-ne dacă suspectezi acces neautorizat la contul tău.
...
Site‑ul nu este destinat minorilor sub 18 ani. Dacă ai motive să crezi că un minor ne-a furnizat date, contactează-ne și vom lua măsurile necesare.

---

## 12) Modificări ale Politicii

Putem actualiza această politică periodic. Versiunea curentă va fi publicată pe Site, cu actualizarea datei.
