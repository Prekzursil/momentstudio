...
@Component({
  ...
  template: `
    ...
    >
      ...
      <div
        *ngIf="requestId"
        class="mt-2 flex flex-wrap items-center gap-2 text-xs text-rose-800/90 dark:text-rose-100/80"
      >
        ...
        ></app-button>
        <span *ngIf="copied()" class="text-rose-700 dark:text-rose-200">{{
          'adminUi.errors.copied' | translate
        }}</span>
      </div>
    </div>
  `,
