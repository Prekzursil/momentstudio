...
/** Golden WU admin-cmp-page-draft-ready -- pageDraftReady. */
describe('AdminComponent pageDraftReady (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).pageDraftReady(undefined as any); }).not.toThrow();
  });
});
