...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "provider", _provider_enum(), nullable=False, server_default="sameday"
        ),
    ...
    op.create_index(
        "ix_shipping_lockers_mirror_provider",
        "shipping_lockers_mirror",
        ["provider"],
        unique=False,
    )
    op.create_index(
        "ix_shipping_lockers_mirror_city",
        "shipping_lockers_mirror",
        ["city"],
        unique=False,
    )
    op.create_index(
        "ix_shipping_lockers_mirror_is_active",
        "shipping_lockers_mirror",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        "ix_shipping_lockers_mirror_lat",
        "shipping_lockers_mirror",
        ["lat"],
        unique=False,
    )
    op.create_index(
        "ix_shipping_lockers_mirror_lng",
        "shipping_lockers_mirror",
        ["lng"],
        unique=False,
    )
    op.create_index(
        "ix_shipping_lockers_mirror_last_seen_at",
        "shipping_lockers_mirror",
        ["last_seen_at"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "deactivated_count", sa.Integer(), nullable=False, server_default="0"
        ),
    ...
    op.create_index(
        "ix_shipping_locker_sync_runs_provider",
        "shipping_locker_sync_runs",
        ["provider"],
        unique=False,
    )
    op.create_index(
        "ix_shipping_locker_sync_runs_status",
        "shipping_locker_sync_runs",
        ["status"],
        unique=False,
    )
    op.create_index(
        "ix_shipping_locker_sync_runs_started_at",
        "shipping_locker_sync_runs",
        ["started_at"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_shipping_locker_sync_runs_status", table_name="shipping_locker_sync_runs"
    )
    op.drop_index(
        "ix_shipping_locker_sync_runs_provider", table_name="shipping_locker_sync_runs"
    )
    op.drop_table("shipping_locker_sync_runs")

    op.drop_index(
        "ix_shipping_lockers_mirror_provider_is_active",
        table_name="shipping_lockers_mirror",
    )
    op.drop_index(
        "ix_shipping_lockers_mirror_provider_city", table_name="shipping_lockers_mirror"
    )
    op.drop_index(
        "ix_shipping_lockers_mirror_last_seen_at", table_name="shipping_lockers_mirror"
    )
    op.drop_index(
        "ix_shipping_lockers_mirror_lng", table_name="shipping_lockers_mirror"
    )
    op.drop_index(
        "ix_shipping_lockers_mirror_lat", table_name="shipping_lockers_mirror"
    )
    op.drop_index(
        "ix_shipping_lockers_mirror_is_active", table_name="shipping_lockers_mirror"
    )
    op.drop_index(
        "ix_shipping_lockers_mirror_city", table_name="shipping_lockers_mirror"
    )
    op.drop_index(
        "ix_shipping_lockers_mirror_provider", table_name="shipping_lockers_mirror"
    )
