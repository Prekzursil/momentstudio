...
/** Golden WU shop-cmp-should-keep-subcategory-in-canonical -- shouldKeepSubcategoryInCanonical. */
describe('ShopComponent shouldKeepSubcategoryInCanonical (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).shouldKeepSubcategoryInCanonical(); }).not.toThrow();
  });
});
