...
/** Golden WU admin-products-cmp-open-create-category-from-manager -- openCreateCategoryFromManager. */
describe('AdminProductsComponent openCreateCategoryFromManager (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openCreateCategoryFromManager(); }).not.toThrow();
  });
});
