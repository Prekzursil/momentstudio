...
/** Golden WU admin-cmp-duplicate-product -- duplicateProduct. */
describe('AdminComponent duplicateProduct (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).duplicateProduct(''); }).not.toThrow();
  });
});
