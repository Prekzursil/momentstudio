    ...
    <div class="grid gap-6">
      ...
      <div class="grid gap-6" *ngIf="!loading(); else loadingTpl">
        ...
        >
          <div class="flex items-center justify-between gap-3">
            <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">
              {{ 'adminUi.site.navigation.title' | translate }}
            </h2>
            <div class="flex items-center gap-2">
              <app-button
                size="sm"
          ...
          <div class="grid gap-4">
            ...
            >
              <div class="flex items-center justify-between gap-3">
                <p class="text-sm font-semibold text-slate-900 dark:text-slate-50">
                  {{ 'adminUi.site.navigation.headerLinks' | translate }}
                </p>
                <button
                  type="button"
                  class="text-xs font-medium text-indigo-700 hover:underline dark:text-indigo-300"
              ...
              <p class="text-xs text-slate-500 dark:text-slate-400">
                {{ 'adminUi.site.navigation.dragHint' | translate }}
              </p>

              <div
                *ngIf="navigationForm.header_links.length === 0"
              ...
              >
                <div class="flex items-start justify-between gap-3">
                  ...
                  <div class="flex flex-wrap justify-end gap-2">
                    <app-button
                      ...
                      variant="ghost"
                      label="↑"
                      (action)="moveNavigationLink('header', link.id, -1)"
                    ></app-button>
                    <app-button
                      size="sm"
                      variant="ghost"
                ...
                <div class="mt-3 grid gap-3 md:grid-cols-3 text-sm">
                  <app-input
                    [label]="'adminUi.site.navigation.fields.labelEn' | translate"
                    [(value)]="link.label.en"
                  ></app-input>
                  <app-input
                    [label]="'adminUi.site.navigation.fields.labelRo' | translate"
                    [(value)]="link.label.ro"
                  ></app-input>
                  <app-input
                    [label]="'adminUi.site.navigation.fields.url' | translate"
                    [(value)]="link.url"
                  ></app-input>
                </div>
              </div>
            ...
            >
              <div class="flex items-center justify-between gap-3">
                <p class="text-sm font-semibold text-slate-900 dark:text-slate-50">
                  {{ 'adminUi.site.navigation.footerHandcraftedLinks' | translate }}
                </p>
                <button
                  type="button"
                  class="text-xs font-medium text-indigo-700 hover:underline dark:text-indigo-300"
              ...
              <div
                *ngIf="navigationForm.footer_handcrafted_links.length === 0"
                class="text-sm text-slate-600 dark:text-slate-300"
              >
                {{ 'adminUi.site.navigation.empty' | translate }}
              </div>
            ...
            >
              <div class="flex items-center justify-between gap-3">
                <p class="text-sm font-semibold text-slate-900 dark:text-slate-50">
                  {{ 'adminUi.site.navigation.footerLegalLinks' | translate }}
                </p>
                <button
                  type="button"
                  class="text-xs font-medium text-indigo-700 hover:underline dark:text-indigo-300"
              ...
              <div
                *ngIf="navigationForm.footer_legal_links.length === 0"
                class="text-sm text-slate-600 dark:text-slate-300"
              >
                {{ 'adminUi.site.navigation.empty' | translate }}
              </div>
                ...
                <div class="flex items-start justify-between gap-3">
                  ...
                  <div class="flex flex-wrap justify-end gap-2">
                    <app-button
                      ...
                      variant="ghost"
                      label="↑"
                      (action)="moveNavigationLink('footer_legal', link.id, -1)"
                    ></app-button>
                    <app-button
                      size="sm"
                      variant="ghost"
          ...
          <div class="flex flex-wrap items-center gap-2 text-sm">
            ...
            <span
              ...
              *ngIf="navigationMessage"
              >{{ navigationMessage }}</span
            >
            <span class="text-xs text-rose-700 dark:text-rose-300" *ngIf="navigationError">{{
              navigationError
            }}</span>
          </div>
        </section>
        ...
        >
          <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">
              {{ 'adminUi.site.pages.title' | translate }}
            </h2>
          ...
          <div class="grid gap-3 text-sm">
            <div class="grid gap-2">
              ...
              <ng-container
                *ngIf="cmsPrefs.translationLayout() === 'sideBySide'; else pagesAboutSingle"
              >
                <div class="grid gap-3 md:grid-cols-2">
                  <div class="grid gap-1">
                    ...
                    <app-rich-editor
                      height="420px"
                      [ariaLabel]="('adminUi.site.pages.aboutLabel' | translate) + ' (RO)'"
                      [(value)]="infoForm.about.ro"
                    ></app-rich-editor>
                  </div>
                  <div class="grid gap-1">
                    ...
                    <app-rich-editor
                      height="420px"
                      [ariaLabel]="('adminUi.site.pages.aboutLabel' | translate) + ' (EN)'"
                      [(value)]="infoForm.about.en"
                    ></app-rich-editor>
                  </div>
                </div>
              </ng-container>
              <ng-template #pagesAboutSingle>
                <app-rich-editor
                  height="420px"
                  [ariaLabel]="'adminUi.site.pages.aboutLabel' | translate"
                  [(value)]="infoForm.about[infoLang]"
                ></app-rich-editor>
              </ng-template>
              <div class="flex gap-2">
                <app-button
                  size="sm"
                  [label]="'adminUi.site.pages.saveAbout' | translate"
                  (action)="saveInfoUi('page.about', infoForm.about)"
                ></app-button>
              </div>
            </div>
            ...
            <ng-container *ngIf="showHiddenPages">
              <div class="grid gap-2">
                ...
                <ng-container
                  *ngIf="cmsPrefs.translationLayout() === 'sideBySide'; else pagesFaqSingle"
                >
                  <div class="grid gap-3 md:grid-cols-2">
                    <div class="grid gap-1">
                      <span class="text-xs font-semibold text-slate-600 dark:text-slate-300"
                      ...
                      <app-rich-editor
                        height="320px"
                        [ariaLabel]="('adminUi.site.pages.faqLabel' | translate) + ' (RO)'"
                        [(value)]="infoForm.faq.ro"
                      ></app-rich-editor>
                    </div>
                    <div class="grid gap-1">
                      <span class="text-xs font-semibold text-slate-600 dark:text-slate-300"
                      ...
                      <app-rich-editor
                        height="320px"
                        [ariaLabel]="('adminUi.site.pages.faqLabel' | translate) + ' (EN)'"
                        [(value)]="infoForm.faq.en"
                      ></app-rich-editor>
                    </div>
                  </div>
                </ng-container>
                <ng-template #pagesFaqSingle>
                  <app-rich-editor
                    height="320px"
                    [ariaLabel]="'adminUi.site.pages.faqLabel' | translate"
                    [(value)]="infoForm.faq[infoLang]"
                  ></app-rich-editor>
                </ng-template>
                <div class="flex gap-2">
                  <app-button
                    size="sm"
                    [label]="'adminUi.site.pages.saveFaq' | translate"
                    (action)="saveInfoUi('page.faq', infoForm.faq)"
                  ></app-button>
                </div>
              </div>
              ...
              <div class="grid gap-2">
                ...
                <ng-container
                  *ngIf="cmsPrefs.translationLayout() === 'sideBySide'; else pagesShippingSingle"
                >
                  <div class="grid gap-3 md:grid-cols-2">
                    <div class="grid gap-1">
                      <span class="text-xs font-semibold text-slate-600 dark:text-slate-300"
                      ...
                      <app-rich-editor
                        height="320px"
                        [ariaLabel]="('adminUi.site.pages.shippingLabel' | translate) + ' (RO)'"
                        [(value)]="infoForm.shipping.ro"
                      ></app-rich-editor>
                    </div>
                    <div class="grid gap-1">
                      <span class="text-xs font-semibold text-slate-600 dark:text-slate-300"
                      ...
                      <app-rich-editor
                        height="320px"
                        [ariaLabel]="('adminUi.site.pages.shippingLabel' | translate) + ' (EN)'"
                        [(value)]="infoForm.shipping.en"
                      ></app-rich-editor>
                    </div>
                  </div>
                </ng-container>
                <ng-template #pagesShippingSingle>
                  <app-rich-editor
                    height="320px"
                    [ariaLabel]="'adminUi.site.pages.shippingLabel' | translate"
                    [(value)]="infoForm.shipping[infoLang]"
                  ></app-rich-editor>
                </ng-template>
                <div class="flex gap-2">
                  <app-button
                    size="sm"
                    [label]="'adminUi.site.pages.saveShipping' | translate"
                    (action)="saveInfoUi('page.shipping', infoForm.shipping)"
                  ></app-button>
                </div>
              </div>
            </ng-container>
            ...
            <div class="grid gap-2">
              ...
              <ng-container
                *ngIf="cmsPrefs.translationLayout() === 'sideBySide'; else pagesContactSingle"
              >
                <div class="grid gap-3 md:grid-cols-2">
                  <div class="grid gap-1">
                    <span class="text-xs font-semibold text-slate-600 dark:text-slate-300">RO</span>
                    <app-rich-editor
                      height="320px"
                      [ariaLabel]="('adminUi.site.pages.contactLabel' | translate) + ' (RO)'"
                      [(value)]="infoForm.contact.ro"
                    ></app-rich-editor>
                  </div>
                  <div class="grid gap-1">
                    <span class="text-xs font-semibold text-slate-600 dark:text-slate-300">EN</span>
                    <app-rich-editor
                      height="320px"
                      [ariaLabel]="('adminUi.site.pages.contactLabel' | translate) + ' (EN)'"
                      [(value)]="infoForm.contact.en"
                    ></app-rich-editor>
                  </div>
                </div>
              </ng-container>
              <ng-template #pagesContactSingle>
                <app-rich-editor
                  height="320px"
                  [ariaLabel]="'adminUi.site.pages.contactLabel' | translate"
                  [(value)]="infoForm.contact[infoLang]"
                ></app-rich-editor>
              </ng-template>
              <div class="flex gap-2">
                <app-button
                  size="sm"
                  [label]="'adminUi.site.pages.saveContact' | translate"
                  (action)="saveInfoUi('page.contact', infoForm.contact)"
                ></app-button>
                <span class="text-xs text-emerald-700 dark:text-emerald-300" *ngIf="infoMessage">{{
                  infoMessage
                }}</span>
                <span class="text-xs text-rose-700 dark:text-rose-300" *ngIf="infoError">{{
                  infoError
                }}</span>
              </div>
            </div>
            ...
            >
              ...
              <div class="mt-3 grid gap-3">
                <p class="text-sm text-slate-600 dark:text-slate-300">
                  {{ 'adminUi.site.pages.builder.hint' | translate }}
                </p>

                <div class="grid gap-3 md:grid-cols-[1fr_220px_180px_auto] items-end">
                  <app-input
                    [label]="'adminUi.site.pages.builder.newPageTitle' | translate"
                  ...
                  <label class="grid gap-1 text-sm font-medium text-slate-700 dark:text-slate-200">
                    ...
                    >
                      <option [ngValue]="'blank'">
                        {{ 'adminUi.site.pages.builder.templates.blank' | translate }}
                      </option>
                      <option [ngValue]="'about'">
                        {{ 'adminUi.site.pages.builder.templates.about' | translate }}
                      </option>
                      <option [ngValue]="'faq'">
                        {{ 'adminUi.site.pages.builder.templates.faq' | translate }}
                      </option>
                      <option [ngValue]="'shipping'">
                        {{ 'adminUi.site.pages.builder.templates.shipping' | translate }}
                      </option>
                      <option [ngValue]="'returns'">
                        {{ 'adminUi.site.pages.builder.templates.returns' | translate }}
                      </option>
                    </select>
                  </label>
                  <label class="grid gap-1 text-sm font-medium text-slate-700 dark:text-slate-200">
                    ...
                    >
                      ...
                      <option [ngValue]="'review'">
                        {{ 'adminUi.status.review' | translate }}
                      </option>
                      <option [ngValue]="'published'">
                ...
                >
                  <input
                    type="checkbox"
                    [(ngModel)]="showHiddenPages"
                    (ngModelChange)="onShowHiddenPagesChange()"
                  />
                    ...
                    >
                      ...
                      <optgroup [label]="'adminUi.site.pages.builder.pagesGroup' | translate">
                        <ng-container *ngIf="contentPages.length; else defaultPages">
                          <option *ngFor="let p of visibleContentPages()" [ngValue]="p.key">
                            ...
                            <ng-container *ngIf="p.hidden">
                              ·
                              {{ 'adminUi.site.pages.builder.hiddenTag' | translate }}</ng-container
                            >
                        ...
                        <ng-template #defaultPages>
                          <option [ngValue]="'page.about'">
                            {{ 'adminUi.site.pages.aboutLabel' | translate }}
                          </option>
                          <option [ngValue]="'page.contact'">
                            {{ 'adminUi.site.pages.contactLabel' | translate }}
                          </option>
                        </ng-template>
                      </optgroup>
                  ...
                  <div class="flex flex-wrap items-end gap-2">
                    ...
                    <app-button
                      *ngIf="canTogglePageHidden(pageBlocksKey)"
                      ...
                      variant="ghost"
                      [label]="
                        isPageHidden(pageBlocksKey)
                          ? ('adminUi.actions.unhide' | translate)
                          : ('adminUi.actions.hide' | translate)
                      "
                    ...
                    <ng-container *ngIf="cmsAdvanced()">
                      ...
                      >
                        ...
                        >
                          <option
                            *ngFor="let t of allowedPageBlockTypesForKey(pageBlocksKey)"
                            [ngValue]="t"
                          >
                      ...
                      <app-button
                        ...
                        (action)="addPageBlock(pageBlocksKey)"
                      ></app-button>
                    </ng-container>
                  </div>
                </div>
                  ...
                  >
                    <div class="flex flex-wrap items-start justify-between gap-3">
                      <div class="grid gap-0.5 min-w-0">
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400">
                          {{ pagePublicPath(previewSlug) }} ·
                          {{ cmsPrefs.previewLang().toUpperCase() }} ·
                          {{ cmsPrefs.previewTheme().toUpperCase() }} ·
                          {{ cmsPreviewViewportWidth() }}px
                        </p>
                      </div>
                    ...
                    >
                      ...
                      >
                        {{ 'adminUi.content.previewLinks.expires' | translate }}
                        {{ pagePreviewExpiresAt | date: 'short' }}
                      </p>
                    </div>

                    <div
                      *ngIf="pagePreviewIframeSrc(previewSlug) as iframeSrc; else pagePreviewHint"
                ...
                >
                  <div class="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <div class="flex flex-wrap items-end gap-2">
                      <app-input
                        [label]="'adminUi.content.reusableBlocks.search' | translate"
                        [(value)]="reusableBlocksQuery"
                      ></app-input>
                      <app-button
                        size="sm"
                        variant="ghost"
                  ...
                  <div
                    *ngIf="!reusableBlocksLoading && filteredReusableBlocks().length === 0"
                    class="text-sm text-slate-600 dark:text-slate-300"
                  >
                  ...
                  <div
                    *ngIf="!reusableBlocksLoading && filteredReusableBlocks().length"
                    class="grid gap-2"
                  >
                    <div
                    ...
                    >
                      <div class="grid gap-0.5 min-w-0">
                        ...
                        <p class="text-[11px] text-slate-500 dark:text-slate-400 truncate">
                          {{ 'adminUi.home.sections.blocks.' + snippet.block.type | translate }} ·
                          {{ snippet.id }}
                        </p>
                      </div>
                ...
                >
                  <span class="font-semibold">{{
                    'adminUi.site.pages.builder.translation.title' | translate
                  }}</span>
                  <label class="flex items-center gap-2">
                    <input
                      type="checkbox"
                  ...
                  <span
                    *ngIf="pageBlocksTranslationSaving[pageBlocksKey]"
                ...
                <div
                  class="grid gap-2"
                  (dragover)="onCmsMediaDragOver($event)"
                  (drop)="onPageMediaDropOnContainer($event, pageBlocksKey)"
                >
                  <div
                  ...
                  <ng-container
                    *ngFor="let block of pageBlocks[pageBlocksKey] || []; let i = index"
                  >
                    <div
                    ...
                    >
                        ...
                        <div class="flex items-center gap-3 shrink-0">
                          ...
                          >
                            <input
                              ...
                              (change)="togglePageBlockEnabled(pageBlocksKey, block.key, $event)"
                            />
                          ...
                          <div class="flex items-center gap-1">
                            <button
                              ...
                              [attr.title]="
                                ('adminUi.content.reorder.moveUp' | translate) +
                                ': ' +
                                pageBlockLabel(block)
                              "
                              [attr.aria-label]="
                                ('adminUi.content.reorder.moveUp' | translate) +
                                ': ' +
                            ...
                            <button
                              ...
                              class="inline-flex h-8 w-8 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-40 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700/40"
                              [attr.title]="
                                ('adminUi.content.reorder.moveDown' | translate) +
                                ': ' +
                                pageBlockLabel(block)
                              "
                              [attr.aria-label]="
                          ...
                          <span class="text-xs text-slate-500 dark:text-slate-400">{{
                            'adminUi.home.sections.drag' | translate
                          }}</span>
                          <app-button
                            size="sm"
                            variant="ghost"
                            [label]="'adminUi.actions.delete' | translate"
                            (action)="removePageBlock(pageBlocksKey, block.key)"
                          ></app-button>
                        </div>
                      </div>
                      ...
                      <div class="mt-3 grid gap-3" *ngIf="block.enabled">
                        <ng-container
                          *ngIf="
                            cmsPrefs.translationLayout() === 'sideBySide';
                            else pageBlockTitleSingle
                          "
                        >
                          <app-localized-text-editor
                            [label]="'adminUi.home.sections.fields.title' | translate"
                            [value]="block.title"
                          ></app-localized-text-editor>
                        </ng-container>
                        ...
                        <div class="grid gap-3 sm:grid-cols-2">
                          ...
                          >
                            ...
                            >
                              <option [ngValue]="'none'">
                                {{ 'adminUi.site.pages.builder.styles.spacing.none' | translate }}
                              </option>
                              <option [ngValue]="'sm'">
                                {{ 'adminUi.site.pages.builder.styles.spacing.sm' | translate }}
                              </option>
                              <option [ngValue]="'md'">
                                {{ 'adminUi.site.pages.builder.styles.spacing.md' | translate }}
                              </option>
                              <option [ngValue]="'lg'">
                                {{ 'adminUi.site.pages.builder.styles.spacing.lg' | translate }}
                              </option>
                            </select>
                          </label>
                          ...
                          >
                            ...
                            >
                              <option [ngValue]="'none'">
                                {{
                                  'adminUi.site.pages.builder.styles.background.none' | translate
                                }}
                              </option>
                              <option [ngValue]="'muted'">
                                {{
                                  'adminUi.site.pages.builder.styles.background.muted' | translate
                                }}
                              </option>
                              <option [ngValue]="'accent'">
                                {{
                                  'adminUi.site.pages.builder.styles.background.accent' | translate
                                }}
                              </option>
                            </select>
                          </label>
                          ...
                          >
                            ...
                            >
                              <option [ngValue]="'left'">
                                {{ 'adminUi.site.pages.builder.styles.align.left' | translate }}
                              </option>
                              <option [ngValue]="'center'">
                                {{ 'adminUi.site.pages.builder.styles.align.center' | translate }}
                              </option>
                            </select>
                          </label>
                          ...
                          >
                            ...
                            >
                              <option [ngValue]="'full'">
                                {{ 'adminUi.site.pages.builder.styles.maxWidth.full' | translate }}
                              </option>
                              <option [ngValue]="'narrow'">
                                {{
                                  'adminUi.site.pages.builder.styles.maxWidth.narrow' | translate
                                }}
                              </option>
                              <option [ngValue]="'prose'">
                                {{ 'adminUi.site.pages.builder.styles.maxWidth.prose' | translate }}
                              </option>
                              <option [ngValue]="'wide'">
                                {{ 'adminUi.site.pages.builder.styles.maxWidth.wide' | translate }}
                              </option>
                            </select>
                          </label>
                        </div>
                        ...
                        <ng-container [ngSwitch]="block.type">
                              ...
                              <div class="grid gap-2">
                                ...
                                >
                                  <div class="flex items-center justify-between gap-3">
                                    ...
                                    >
                                      {{ 'adminUi.home.sections.fields.column' | translate }}
                                      {{ colIdx + 1 }}
                                    </span>
                                    <app-button
                                      size="sm"
                                      ...
                                      [label]="'adminUi.actions.delete' | translate"
                                      (action)="
                                        removePageColumnsColumn(pageBlocksKey, block.key, colIdx)
                                      "
                                    ></app-button>
                                  </div>
                                  ...
                                  <div class="mt-3 grid gap-3">
                                    <ng-container
                                      *ngIf="
                                        cmsPrefs.translationLayout() === 'sideBySide';
                                        else pageBlockColumnsTextSingle
                                      "
                                    >
                                      <app-localized-text-editor
                                        [label]="
                          ...
                          <ng-container *ngSwitchCase="'product_grid'">
                            <div class="grid gap-3">
                              ...
                              >
                                ...
                                >
                                  <option [ngValue]="'category'">
                                    {{
                                      'adminUi.home.sections.productGridSources.category'
                                        | translate
                                    }}
                                  </option>
                                  <option [ngValue]="'collection'">
                                    {{
                                      'adminUi.home.sections.productGridSources.collection'
                                        | translate
                                    }}
                                  </option>
                                  <option [ngValue]="'products'">
                                    {{
                                      'adminUi.home.sections.productGridSources.products'
                                        | translate
                                    }}
                                  </option>
                                </select>
                              ...
                              >
                                {{
                                  'adminUi.home.sections.fields.productGridCollectionSlug'
                                    | translate
                                }}
                                <input
                                  class="h-10 rounded-lg border border-slate-200 bg-white px-3 text-sm text-slate-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/40 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
                                ...
                                <datalist [id]="'product-grid-collection-slugs-' + block.key">
                                  <option
                                    *ngFor="let col of featuredCollections"
                                    [value]="col.slug"
                                  >
                                    {{ col.name }}
                                  </option>
                              ...
                              >
                                ...
                                >
                                  {{
                                    'adminUi.home.sections.fields.productGridProductSlugs'
                                      | translate
                                  }}
                                  <textarea
                                    class="rounded-lg border border-slate-200 bg-white px-3 py-2 text-slate-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/40 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
                                  ...
                                  <span class="text-xs text-slate-500 dark:text-slate-400">
                                    {{
                                      'adminUi.home.sections.fields.productGridProductSlugsHint'
                                        | translate
                                    }}
                                  </span>
                                </label>
                                ...
                                >
                                  ...
                                  >
                                    {{
                                      'adminUi.home.sections.fields.productGridProductSearch'
                                        | translate
                                    }}
                                  </p>
                                  <div class="flex flex-wrap items-center gap-2">
                                    <input
                                      ...
                                      (ngModelChange)="
                                        queueProductGridProductSearch(block.key, $event)
                                      "
                                      [placeholder]="
                                        'adminUi.home.sections.fields.productGridProductSearchPlaceholder'
                                          | translate
                                      "
                                    />
                                    <app-button
                                  ...
                                  <div
                                    *ngIf="productGridProductSearchLoading[block.key]"
                                    class="text-xs text-slate-500 dark:text-slate-400"
                                  >
                                    {{ 'adminUi.common.loading' | translate }}
                                  </div>
                                  <div
                                    *ngIf="productGridProductSearchError[block.key]"
                                    class="text-xs text-rose-700 dark:text-rose-300"
                                  >
                                  ...
                                  <div
                                    *ngIf="
                                      productGridProductSearchResults[block.key]?.length;
                                      else productGridSearchEmptyTpl
                                    "
                                    class="grid gap-2"
                                  >
                                    <div
                                      *ngFor="
                                        let item of productGridProductSearchResults[block.key]
                                      "
                                    ...
                                    >
                                      <div class="min-w-0">
                                        <p
                                          class="font-semibold truncate text-slate-900 dark:text-slate-50"
                                        >
                                          {{ item.name }}
                                        </p>
                                  ...
                                  <ng-template #productGridSearchEmptyTpl>
                                    <div
                                      *ngIf="
                                        (productGridProductSearchQuery[block.key] || '').trim()
                                      "
                                      class="text-xs text-slate-500 dark:text-slate-400"
                                    >
                                      {{
                                        'adminUi.home.sections.fields.productGridProductSearchEmpty'
                                          | translate
                                      }}
                                    </div>
                                  </ng-template>
                              ...
                              >
                                ...
                                >
                                  <option [ngValue]="'contact'">
                                    {{ 'adminUi.home.sections.formTypes.contact' | translate }}
                                  </option>
                                  <option [ngValue]="'newsletter'">
                                    {{ 'adminUi.home.sections.formTypes.newsletter' | translate }}
                                  </option>
                                </select>
                              </label>
                                ...
                                >
                                  <div class="flex items-center justify-between gap-3">
                                    <span
                                      class="text-xs font-semibold text-slate-700 dark:text-slate-200"
                                    >
                                      {{ 'adminUi.home.sections.fields.testimonial' | translate }}
                                      {{ idx + 1 }}
                                    </span>
                                    <app-button
                                      size="sm"
                                      ...
                                      [label]="'adminUi.actions.delete' | translate"
                                      (action)="
                                        removePageTestimonial(pageBlocksKey, block.key, idx)
                                      "
                                    ></app-button>
                                  </div>
                                  ...
                                  <ng-container
                                    *ngIf="
                                      cmsPrefs.translationLayout() === 'sideBySide';
                                      else pageBlockTestimonialsTextSingle
                                    "
                                  >
                                    <app-localized-text-editor
                            ...
                            >
                              ...
                              <div class="mt-3">
                                <app-asset-library
                                  ...
                                  (selectAsset)="
                                    setPageImageBlockUrl(pageBlocksKey, block.key, $event)
                                  "
                                ></app-asset-library>
                              </div>
                            </details>
                          ...
                          <ng-container *ngSwitchCase="'gallery'">
                            <div class="flex items-center justify-between">
                              ...
                              <app-button
                                ...
                                variant="ghost"
                                [label]="'adminUi.actions.add' | translate"
                                (action)="addPageGalleryImage(pageBlocksKey, block.key)"
                              ></app-button>
                            </div>
                            <div
                              *ngIf="block.images.length === 0"
                            ...
                            <div *ngIf="block.images.length" class="grid gap-3">
                              <div
                                *ngFor="let img of block.images; let idx = index"
                                class="grid gap-2 rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950/30"
                              >
                                <div class="flex items-center justify-between gap-2">
                                  <p
                                    class="text-xs font-semibold text-slate-700 dark:text-slate-200"
                                  >
                                    {{ 'adminUi.home.sections.fields.image' | translate }}
                                    {{ idx + 1 }}
                                  </p>
                                  <app-button
                                    size="sm"
                                    variant="ghost"
                                    [label]="'adminUi.actions.remove' | translate"
                                    (action)="removePageGalleryImage(pageBlocksKey, block.key, idx)"
                                  ></app-button>
                                </div>
                                <label
                                  class="grid gap-1 text-sm font-medium text-slate-700 dark:text-slate-200"
                                ...
                                <ng-container
                                  *ngIf="
                                    cmsPrefs.translationLayout() === 'sideBySide';
                                    else pageBlockGalleryTextSingle
                                  "
                                >
                                  <div class="grid gap-3">
                                    <app-localized-text-editor
                                  ...
                                  <img
                                    *ngIf="(img.url || '').trim()"
                                    ...
                                    [style.object-position]="
                                      focalPosition(img.focal_x, img.focal_y)
                                    "
                                    loading="lazy"
                                  />
                                </div>
                              ...
                              >
                                ...
                                <div class="mt-3">
                                  <app-asset-library
                                    ...
                                    [initialKey]="pageBlocksKey"
                                    (selectAsset)="
                                      addPageGalleryImageFromAsset(pageBlocksKey, block.key, $event)
                                    "
                                  ></app-asset-library>
                                </div>
                              </details>
                            ...
                            <div class="grid gap-3">
                              <div class="grid gap-3 md:grid-cols-2">
                                ...
                                <ng-container
                                  *ngIf="
                                    cmsPrefs.translationLayout() === 'sideBySide';
                                    else pageBlockBannerHeadlineSingle
                                  "
                                >
                                  <app-localized-text-editor
                                    class="md:col-span-2"
                                ...
                                <ng-container
                                  *ngIf="
                                    cmsPrefs.translationLayout() === 'sideBySide';
                                    else pageBlockBannerSubheadlineSingle
                                  "
                                >
                                  <app-localized-text-editor
                                    class="md:col-span-2"
                                ...
                                <ng-container
                                  *ngIf="
                                    cmsPrefs.translationLayout() === 'sideBySide';
                                    else pageBlockBannerCtaLabelSingle
                                  "
                                >
                                  <app-localized-text-editor
                                    class="md:col-span-2"
                              ...
                              <div class="grid gap-3 md:grid-cols-3">
                                ...
                                >
                                  ...
                                  >
                                    <option [ngValue]="'split'">
                                      {{ 'adminUi.home.sections.variants.split' | translate }}
                                    </option>
                                    <option [ngValue]="'full'">
                                      {{ 'adminUi.home.sections.variants.full' | translate }}
                                    </option>
                                  </select>
                                </label>
                                <label
                                ...
                                >
                                  ...
                                  >
                                    <option [ngValue]="'S'">
                                      {{ 'adminUi.home.sections.sizes.s' | translate }}
                                    </option>
                                    <option [ngValue]="'M'">
                                      {{ 'adminUi.home.sections.sizes.m' | translate }}
                                    </option>
                                    <option [ngValue]="'L'">
                                      {{ 'adminUi.home.sections.sizes.l' | translate }}
                                    </option>
                                  </select>
                                </label>
                                <label
                                ...
                                >
                                  ...
                                  >
                                    <option [ngValue]="'dark'">
                                      {{ 'adminUi.home.sections.textStyle.dark' | translate }}
                                    </option>
                                    <option [ngValue]="'light'">
                                      {{ 'adminUi.home.sections.textStyle.light' | translate }}
                                    </option>
                                  </select>
                                </label>
                              </div>
                              ...
                              >
                                ...
                                <div class="mt-3">
                                  <app-asset-library
                                    ...
                                    [initialKey]="pageBlocksKey"
                                    (selectAsset)="
                                      setPageBannerSlideImage(pageBlocksKey, block.key, $event)
                                    "
                                  ></app-asset-library>
                                </div>
                              </details>
                              ...
                              >
                                ...
                                <div class="mt-3">
                                  <app-banner-block
                                    [slide]="toPreviewSlide(block.slide, infoLang)"
                                  ></app-banner-block>
                                </div>
                              </details>
                            </div>
                          ...
                          <ng-container *ngSwitchCase="'carousel'">
                            <div class="grid gap-3">
                              <div
                                class="rounded-lg border border-slate-200 bg-slate-50 p-3 grid gap-3 dark:border-slate-800 dark:bg-slate-950/30"
                              >
                                <div class="flex items-center justify-between">
                                  <p
                                    class="text-xs font-semibold tracking-wide uppercase text-slate-500 dark:text-slate-400"
                                  >
                                    {{ 'adminUi.home.sections.fields.slides' | translate }}
                                  </p>
                                  <app-button
                                    size="sm"
                                    [label]="'adminUi.actions.add' | translate"
                                    (action)="addPageCarouselSlide(pageBlocksKey, block.key)"
                                  ></app-button>
                                </div>
                                <div
                                ...
                                >
                                  <div class="flex items-center justify-between gap-2">
                                    ...
                                    >
                                      {{ 'adminUi.home.sections.fields.slide' | translate }}
                                      {{ idx + 1 }}
                                    </p>
                                    <div class="flex items-center gap-2">
                                      <app-button
                                        ...
                                        (action)="
                                          movePageCarouselSlide(pageBlocksKey, block.key, idx, -1)
                                        "
                                      ></app-button>
                                      <app-button
                                        size="sm"
                                      ...
                                      <app-button
                                        ...
                                        [label]="'adminUi.actions.remove' | translate"
                                        (action)="
                                          removePageCarouselSlide(pageBlocksKey, block.key, idx)
                                        "
                                      ></app-button>
                                    </div>
                                  </div>
                                  ...
                                  <div class="grid gap-3 md:grid-cols-2">
                                    <ng-container
                                      *ngIf="
                                        cmsPrefs.translationLayout() === 'sideBySide';
                                        else pageBlockCarouselAltSingle
                                      "
                                    >
                                      <app-localized-text-editor
                                        class="md:col-span-2"
                                    ...
                                    <ng-container
                                      *ngIf="
                                        cmsPrefs.translationLayout() === 'sideBySide';
                                        else pageBlockCarouselHeadlineSingle
                                      "
                                    >
                                      <app-localized-text-editor
                                        class="md:col-span-2"
                                    ...
                                    <ng-container
                                      *ngIf="
                                        cmsPrefs.translationLayout() === 'sideBySide';
                                        else pageBlockCarouselSubheadlineSingle
                                      "
                                    >
                                      <app-localized-text-editor
                                        class="md:col-span-2"
                              ...
                              <div class="grid gap-3 md:grid-cols-2">
                                ...
                                >
                                  ...
                                  <span>{{
                                    'adminUi.home.sections.fields.autoplay' | translate
                                  }}</span>
                                </label>
                                <label
                                  class="grid gap-1 text-sm font-medium text-slate-700 dark:text-slate-200"
                                ...
                                >
                                  ...
                                  <span>{{
                                    'adminUi.home.sections.fields.arrows' | translate
                                  }}</span>
                                </label>
                                <label
                                  class="flex items-center gap-2 text-sm font-medium text-slate-700 dark:text-slate-200"
                              ...
                              >
                                ...
                                <div class="mt-3">
                                  <app-carousel-block
                                    [slides]="toPreviewSlides(block.slides, infoLang)"
                ...
                <div
                  *ngIf="cmsAdvanced() && pageKeySupportsRequiresAuth(pageBlocksKey)"
                  class="grid gap-1"
                >
                  <label
                    class="flex items-center gap-2 text-sm font-medium text-slate-700 dark:text-slate-200"
                  ...
                  <p class="text-xs text-slate-500 dark:text-slate-400">
                    {{ 'adminUi.site.pages.builder.requiresLoginHint' | translate }}
                  </p>
                </div>
                ...
                >
                  <div class="flex flex-wrap items-center gap-2">
                    ...
                    <span
                      *ngIf="pageDraftRestoreAt(pageBlocksKey)"
                ...
                <div class="flex flex-wrap items-center gap-2">
                  ...
                  <app-button
                    size="sm"
                    [label]="'adminUi.actions.save' | translate"
                    (action)="savePageBlocks(pageBlocksKey)"
                  ></app-button>
                  <span
                    *ngIf="pageDraftReady(pageBlocksKey)"
                    class="text-xs text-slate-500 dark:text-slate-400"
                  >
                    ...
                    <ng-container
                      *ngIf="pageDraftDirty(pageBlocksKey) && pageDraftAutosaving(pageBlocksKey)"
                    >
                  ...
                  <span
                    class="text-xs text-emerald-700 dark:text-emerald-300"
                    *ngIf="pageBlocksMessage[pageBlocksKey]"
                  >
                    {{ pageBlocksMessage[pageBlocksKey] }}
                  </span>
                  <span
                    class="text-xs text-rose-700 dark:text-rose-300"
                    *ngIf="pageBlocksError[pageBlocksKey]"
                  >
            ...
            >
              <div class="grid gap-3">
                <p
                  *ngIf="pagePublishChecklistLoading"
                  class="text-sm text-slate-600 dark:text-slate-300"
                >
                ...
                <p
                  *ngIf="pagePublishChecklistError"
                ...
                >
                  <div class="grid gap-1">
                    ...
                    <p
                      *ngIf="checklist.missingTranslations.length === 0"
                    ...
                    >
                      {{
                        'adminUi.content.publishChecklist.translationsMissing'
                          | translate
                            : { langs: checklist.missingTranslations.join(', ').toUpperCase() }
                      }}
                    </p>
                  </div>
                  ...
                  <div class="grid gap-1">
                    ...
                    <p
                      *ngIf="checklist.missingAlt.length === 0"
                      class="text-sm text-emerald-700 dark:text-emerald-300"
                    >
                      {{ 'adminUi.content.publishChecklist.ok' | translate }}
                    </p>
                    <div *ngIf="checklist.missingAlt.length > 0" class="grid gap-1">
                      <p class="text-sm text-amber-800 dark:text-amber-200">
                        {{
                          'adminUi.content.publishChecklist.altMissing'
                            | translate: { count: checklist.missingAlt.length }
                        }}
                      </p>
                  ...
                  <div class="grid gap-1">
                    ...
                    <p
                      *ngIf="checklist.emptySections.length === 0"
                      class="text-sm text-emerald-700 dark:text-emerald-300"
                    >
                      {{ 'adminUi.content.publishChecklist.ok' | translate }}
                    </p>
                    <div *ngIf="checklist.emptySections.length > 0" class="grid gap-1">
                      <p class="text-sm text-amber-800 dark:text-amber-200">
                        {{
                          'adminUi.content.publishChecklist.emptyFound'
                            | translate: { count: checklist.emptySections.length }
                        }}
                      </p>
                      <ul class="list-disc pl-5 text-xs text-slate-600 dark:text-slate-300">
                        <li *ngFor="let item of checklist.emptySections | slice: 0 : 6">
                          {{ item }}
                        </li>
                      </ul>
                    </div>
                  ...
                  <div class="grid gap-1">
                    ...
                    <p
                      *ngIf="checklist.linkIssues.length === 0 && !pagePublishChecklistLoading"
                      class="text-sm text-emerald-700 dark:text-emerald-300"
                    >
                      {{ 'adminUi.content.publishChecklist.ok' | translate }}
                    </p>
                    <div *ngIf="checklist.linkIssues.length > 0" class="grid gap-1">
                      <p class="text-sm text-rose-700 dark:text-rose-300">
                        {{
                          'adminUi.content.publishChecklist.linksFound'
                            | translate: { count: checklist.linkIssues.length }
                        }}
                      </p>
                      <ul class="list-disc pl-5 text-xs text-slate-600 dark:text-slate-300">
            ...
            >
              ...
              <div class="mt-3 grid gap-3">
                <p class="text-sm text-slate-600 dark:text-slate-300">
                  {{ 'adminUi.site.pages.redirects.hint' | translate }}
                </p>

                <div class="flex flex-wrap gap-2 items-end">
                  <app-input
                    [label]="'adminUi.site.pages.redirects.search' | translate"
                  ...
                  <app-button
                    ...
                    variant="ghost"
                    [label]="'adminUi.actions.search' | translate"
                    (action)="loadContentRedirects(true)"
                  ></app-button>
                  <app-button
                    size="sm"
                    variant="ghost"
                ...
                >
                  ...
                  <div class="flex flex-wrap items-end gap-2">
                    <app-input
                      [label]="'adminUi.site.pages.redirects.createFrom' | translate"
                      [(value)]="redirectCreateFrom"
                    ></app-input>
                    <app-input
                      [label]="'adminUi.site.pages.redirects.createTo' | translate"
                      [(value)]="redirectCreateTo"
                    ></app-input>
                    <app-button
                      size="sm"
                      variant="ghost"
                ...
                <div
                  *ngIf="redirectsImportResult"
                  class="rounded-lg border border-slate-200 bg-white p-2 text-xs text-slate-700 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200"
                >
                  <p class="font-semibold">
                    {{
                      'adminUi.site.pages.redirects.importResult'
                        | translate
                          : {
                              created: redirectsImportResult.created,
                              updated: redirectsImportResult.updated,
                              skipped: redirectsImportResult.skipped,
                            }
                    }}
                  </p>
                  <div *ngIf="redirectsImportResult.errors?.length" class="mt-1 grid gap-1">
                    <p class="text-rose-700 dark:text-rose-300">
                      {{ 'adminUi.site.pages.redirects.importErrors' | translate }}
                    </p>
                    <p
                      *ngFor="let e of redirectsImportResult.errors"
                      class="text-[11px] text-rose-700 dark:text-rose-300"
                    >
                      #{{ e.line }}: {{ e.error }}
                    </p>
                  </div>
                ...
                <div
                  *ngIf="!redirectsLoading && !redirectsError && redirects.length === 0"
                  class="text-sm text-slate-600 dark:text-slate-300"
                >
                ...
                <div *ngIf="!redirectsLoading && redirects.length" class="grid gap-2">
                  ...
                  >
                    <div class="min-w-0">
                      ...
                      <p
                        *ngIf="r.chain_error === 'loop'"
                        class="text-xs text-rose-700 dark:text-rose-300"
                      >
                        {{ 'adminUi.site.pages.redirects.loop' | translate }}
                      </p>
                      <p
                        *ngIf="r.chain_error === 'too_deep'"
                    ...
                    <app-button
                      ...
                      variant="ghost"
                      [label]="'adminUi.actions.delete' | translate"
                      (action)="deleteContentRedirect(r.id)"
                    ></app-button>
                  </div>
                </div>
            ...
            >
              ...
              <div class="mt-3 grid gap-3">
                ...
                <app-content-revisions
                  [contentKey]="pagesRevisionKey"
                  [titleKey]="pagesRevisionTitleKey()"
                ></app-content-revisions>
              </div>
            </details>
            ...
            >
              ...
              <div class="mt-3 grid gap-3">
                <p class="text-sm text-slate-600 dark:text-slate-300">
                  {{ 'adminUi.content.findReplace.hint' | translate }}
                </p>

                <div class="grid gap-2 md:grid-cols-2">
                  <app-input
                    [label]="'adminUi.content.findReplace.find' | translate"
                    [(value)]="findReplaceFind"
                  ></app-input>
                  <app-input
                    [label]="'adminUi.content.findReplace.replace' | translate"
                    [(value)]="findReplaceReplace"
                  ></app-input>
                </div>
                ...
                <div class="flex flex-wrap gap-3 items-end">
                  <label class="grid gap-1 text-xs font-medium text-slate-700 dark:text-slate-200">
                    ...
                    >
                      <option value="all">
                        {{ 'adminUi.content.findReplace.scope.all' | translate }}
                      </option>
                      <option value="pages">
                        {{ 'adminUi.content.findReplace.scope.pages' | translate }}
                      </option>
                      <option value="blog">
                        {{ 'adminUi.content.findReplace.scope.blog' | translate }}
                      </option>
                      <option value="home">
                        {{ 'adminUi.content.findReplace.scope.home' | translate }}
                      </option>
                      <option value="site">
                        {{ 'adminUi.content.findReplace.scope.site' | translate }}
                      </option>
                    </select>
                  </label>
                  ...
                  <div class="flex flex-wrap gap-2">
                    ...
                    <app-button
                      ...
                      [disabled]="
                        ...
                        findReplaceApplying ||
                        !findReplacePreview ||
                        findReplacePreview.total_items === 0
                      "
                ...
                <div
                  *ngIf="findReplacePreview && !findReplaceLoading && !findReplaceError"
                  class="grid gap-2"
                >
                  <div class="text-xs text-slate-500 dark:text-slate-400">
                    {{
                      'adminUi.content.findReplace.summary'
                        | translate
                          : {
                              items: findReplacePreview.total_items,
                              matches: findReplacePreview.total_matches,
                            }
                    }}
                  </div>

                  <div
                    *ngIf="findReplacePreview.total_items === 0"
                    class="text-sm text-slate-600 dark:text-slate-300"
                  >
                  ...
                  <div
                    *ngIf="findReplacePreview.truncated"
                    class="text-xs text-slate-500 dark:text-slate-400"
                  >
                ...
                <div
                  *ngIf="findReplaceApplyResult"
                  class="rounded-lg border border-slate-200 bg-white p-2 text-xs text-slate-700 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200"
                >
                  <p class="font-semibold">
                    {{
                      'adminUi.content.findReplace.result'
                        | translate
                          : {
                              blocks: findReplaceApplyResult.updated_blocks,
                              translations: findReplaceApplyResult.updated_translations,
                              replacements: findReplaceApplyResult.total_replacements,
                            }
                    }}
                  </p>
                  <div *ngIf="findReplaceApplyResult.errors?.length" class="mt-1 grid gap-1">
                    <p class="text-rose-700 dark:text-rose-300">
                      {{ 'adminUi.content.findReplace.applyErrors' | translate }}
                    </p>
                    <p
                      *ngFor="let e of findReplaceApplyResult.errors"
                      class="text-[11px] text-rose-700 dark:text-rose-300"
                    >
                      {{ e.key }}: {{ e.error }}
                    </p>
            ...
            >
              ...
              <div class="mt-3 grid gap-3">
                <p class="text-sm text-slate-600 dark:text-slate-300">
                  {{ 'adminUi.content.linkCheck.hint' | translate }}
                </p>

                <div class="flex flex-wrap gap-2 items-end">
                  <app-input
                    [label]="'adminUi.content.linkCheck.key' | translate"
                    [(value)]="linkCheckKey"
                  ></app-input>
                  <app-button
                    size="sm"
                    [label]="'adminUi.content.linkCheck.run' | translate"
                    (action)="runLinkCheck()"
                  ></app-button>
                  <app-button
                    size="sm"
                ...
                <div
                  *ngIf="!linkCheckLoading && !linkCheckError && linkCheckIssues.length === 0"
                  class="text-sm text-slate-600 dark:text-slate-300"
                >
                ...
                <div *ngIf="!linkCheckLoading && linkCheckIssues.length" class="grid gap-2">
                  ...
                  >
                    ...
                    <p class="mt-1 text-xs text-slate-600 dark:text-slate-300 font-mono break-all">
                      {{ issue.url }}
                    </p>
        ...
        >
          <div class="flex flex-wrap items-start justify-between gap-3">
            <div class="grid gap-1">
              <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">
                {{ 'adminUi.home.sections.title' | translate }}
              </h2>
              <p class="text-sm text-slate-600 dark:text-slate-300">
                {{ 'adminUi.home.sections.hint' | translate }}
              </p>
            </div>
            <div class="flex flex-wrap items-center gap-2 text-sm">
              <div class="flex gap-2">
              ...
              <span *ngIf="homeDraftReady()" class="text-xs text-slate-500 dark:text-slate-400">
                ...
                <ng-container
                  *ngIf="homeDraftDirty() && !homeDraftAutosaving() && homeDraftLastAutosavedAt()"
                >
                  {{ 'adminUi.content.autosave.state.autosaved' | translate }}
                  {{ homeDraftLastAutosavedAt() | date: 'shortTime' }}
                </ng-container>
                <ng-container
                  *ngIf="homeDraftDirty() && !homeDraftAutosaving() && !homeDraftLastAutosavedAt()"
                >
          ...
          >
            <div class="flex flex-wrap items-center gap-2">
              ...
              <span *ngIf="homeDraftRestoreAt()" class="text-amber-700 dark:text-amber-200">{{
                homeDraftRestoreAt() | date: 'short'
              }}</span>
            </div>
            <div class="flex flex-wrap items-center gap-2">
              <app-button
                ...
                variant="ghost"
                [label]="'adminUi.actions.restore' | translate"
                (action)="restoreHomeDraftAutosave()"
              ></app-button>
              <app-button
                size="sm"
                variant="ghost"
                [label]="'adminUi.actions.dismiss' | translate"
                (action)="dismissHomeDraftAutosave()"
              ></app-button>
            </div>
          </div>
          ...
          >
            ...
            <div *ngIf="homePreviewShareUrl() as previewUrl" class="mt-3 grid gap-2">
              ...
              <p *ngIf="homePreviewExpiresAt" class="text-xs text-slate-500 dark:text-slate-400">
                {{ 'adminUi.content.previewLinks.expires' | translate }}
                {{ homePreviewExpiresAt | date: 'short' }}
              </p>
            </div>

            <div
              *ngIf="homePreviewIframeSrc() as iframeSrc; else homePreviewHint"
              class="mt-3 overflow-x-auto"
            >
              <div
                class="mx-auto rounded-lg border border-slate-200 bg-white p-2 dark:border-slate-800 dark:bg-slate-900"
          ...
          <div *ngIf="cmsAdvanced()" class="grid gap-3 md:grid-cols-[1fr_auto] items-end">
            <label class="grid gap-1 text-sm font-medium text-slate-700 dark:text-slate-200">
              ...
              >
                <option [ngValue]="'text'">
                  {{ 'adminUi.home.sections.blocks.text' | translate }}
                </option>
                <option [ngValue]="'columns'">
                  {{ 'adminUi.home.sections.blocks.columns' | translate }}
                </option>
                <option [ngValue]="'cta'">
                  {{ 'adminUi.home.sections.blocks.cta' | translate }}
                </option>
                <option [ngValue]="'faq'">
                  {{ 'adminUi.home.sections.blocks.faq' | translate }}
                </option>
                <option [ngValue]="'testimonials'">
                  {{ 'adminUi.home.sections.blocks.testimonials' | translate }}
                </option>
                <option [ngValue]="'image'">
                  {{ 'adminUi.home.sections.blocks.image' | translate }}
                </option>
                <option [ngValue]="'gallery'">
                  {{ 'adminUi.home.sections.blocks.gallery' | translate }}
                </option>
                <option [ngValue]="'banner'">
                  {{ 'adminUi.home.sections.blocks.banner' | translate }}
                </option>
                <option [ngValue]="'carousel'">
                  {{ 'adminUi.home.sections.blocks.carousel' | translate }}
                </option>
              </select>
            </label>
            <app-button
          ...
          <div
            class="grid gap-2"
            (dragover)="onCmsMediaDragOver($event)"
            (drop)="onHomeMediaDropOnContainer($event)"
          >
            <div
                  ...
                  <div class="flex items-center gap-3 shrink-0">
                    ...
                    >
                      <input
                        type="checkbox"
                        [checked]="block.enabled"
                        (change)="toggleHomeBlockEnabled(block, $event)"
                      />
                      {{ 'adminUi.home.sections.enabled' | translate }}
                    </label>
                    <div class="flex items-center gap-1">
                            ...
                            >
                              ...
                              <div class="mt-3 grid gap-3">
                                <ng-container
                                  *ngIf="
                                    cmsPrefs.translationLayout() === 'sideBySide';
                                    else homeBlockColumnsTextSingle
                                  "
                                >
                                  <app-localized-text-editor
                          ...
                          <div class="grid gap-2">
                            ...
                            >
                              ...
                              <ng-container
                                *ngIf="
                                  cmsPrefs.translationLayout() === 'sideBySide';
                                  else homeBlockTestimonialsTextSingle
                                "
                              >
                                <app-localized-text-editor
                                  [label]="'adminUi.home.sections.fields.quote' | translate"
                        ...
                        <div class="grid gap-3">
                          <div class="flex items-center justify-between">
                            ...
                            <app-button
                              ...
                              variant="ghost"
                              [label]="'adminUi.actions.add' | translate"
                              (action)="addGalleryImage(block.key)"
                            ></app-button>
                          </div>
                            ...
                            >
                              <div class="flex items-center justify-between gap-3">
                                ...
                                <app-button
                                  ...
                                  variant="ghost"
                                  [label]="'adminUi.actions.delete' | translate"
                                  (action)="removeGalleryImage(block.key, idx)"
                                ></app-button>
                              </div>
                              <label
                                class="grid gap-1 text-sm font-medium text-slate-700 dark:text-slate-200"
                              ...
                              <div class="grid gap-3 md:grid-cols-2">
                                <ng-container
                                  *ngIf="
                                    cmsPrefs.translationLayout() === 'sideBySide';
                                    else homeBlockGalleryTextSingle
                                  "
                                >
                                  <app-localized-text-editor
                                    class="md:col-span-2"
                        ...
                        <div class="grid gap-3">
                          <div class="grid gap-3 md:grid-cols-2">
                            ...
                            <ng-container
                              *ngIf="
                                cmsPrefs.translationLayout() === 'sideBySide';
                                else homeBlockBannerHeadlineSingle
                              "
                            >
                              <app-localized-text-editor
                                class="md:col-span-2"
                            ...
                            <ng-container
                              *ngIf="
                                cmsPrefs.translationLayout() === 'sideBySide';
                                else homeBlockBannerSubheadlineSingle
                              "
                            >
                              <app-localized-text-editor
                                class="md:col-span-2"
                            ...
                            <ng-container
                              *ngIf="
                                cmsPrefs.translationLayout() === 'sideBySide';
                                else homeBlockBannerCtaLabelSingle
                              "
                            >
                              <app-localized-text-editor
                                class="md:col-span-2"
                          ...
                          >
                            ...
                            <app-banner-block
                              ...
                              [tagline]="
                                homeBlocksLang === 'en' ? 'art. handcrafted' : 'artă. meșteșug'
                              "
                            ></app-banner-block>
                          </div>
                        </div>
                        ...
                        <div class="grid gap-3">
                          ...
                          >
                              ...
                              >
                                <div class="flex items-center justify-between gap-2">
                                  ...
                                  <div class="flex items-center gap-2">
                                    <app-button
                                      ...
                                      variant="ghost"
                                      [label]="'adminUi.actions.up' | translate"
                                      (action)="moveCarouselSlide(block.key, idx, -1)"
                                    ></app-button>
                                    <app-button
                                      size="sm"
                                      variant="ghost"
                                    ...
                                    <app-button
                                      ...
                                      variant="ghost"
                                      [label]="'adminUi.actions.delete' | translate"
                                      (action)="removeCarouselSlide(block.key, idx)"
                                    ></app-button>
                                  </div>
                                </div>
                                ...
                                <div class="grid gap-3 md:grid-cols-2">
                                  ...
                                  <ng-container
                                    *ngIf="
                                      cmsPrefs.translationLayout() === 'sideBySide';
                                      else homeBlockCarouselAltSingle
                                    "
                                  >
                                    <app-localized-text-editor
                                      class="md:col-span-2"
                                  ...
                                  <ng-container
                                    *ngIf="
                                      cmsPrefs.translationLayout() === 'sideBySide';
                                      else homeBlockCarouselHeadlineSingle
                                    "
                                  >
                                    <app-localized-text-editor
                                      class="md:col-span-2"
                                  ...
                                  <ng-container
                                    *ngIf="
                                      cmsPrefs.translationLayout() === 'sideBySide';
                                      else homeBlockCarouselSubheadlineSingle
                                    "
                                  >
                                    <app-localized-text-editor
                                      class="md:col-span-2"
                                  ...
                                  <ng-container
                                    *ngIf="
                                      cmsPrefs.translationLayout() === 'sideBySide';
                                      else homeBlockCarouselCtaLabelSingle
                                    "
                                  >
                                    <app-localized-text-editor
                                      class="md:col-span-2"
                            ...
                            <div class="mt-3 flex gap-2">
                              <app-button
                                size="sm"
                                [label]="'adminUi.actions.add' | translate"
                                (action)="addCarouselSlide(block.key)"
                              ></app-button>
                            </div>
                          </div>
                          ...
                          <div class="grid gap-3 md:grid-cols-2">
                            ...
                            >
                              ...
                              <span>{{
                                'adminUi.home.sections.fields.pauseOnHover' | translate
                              }}</span>
                            </label>
                          </div>
          ...
          <span class="text-xs text-emerald-700 dark:text-emerald-300" *ngIf="sectionsMessage">{{
            sectionsMessage
          }}</span>
        </section>
          ...
          >
            ...
            <div class="mt-3 grid gap-3">
              <label class="grid gap-1 text-sm font-medium text-slate-700 dark:text-slate-200">
                ...
                >
                  <option [ngValue]="'home.sections'">
                    {{ 'adminUi.home.sections.title' | translate }}
                  </option>
                  <option [ngValue]="'home.story'">
                    {{ 'adminUi.home.story.title' | translate }}
                  </option>
                </select>
              </label>
              <app-content-revisions
                [contentKey]="homeRevisionKey"
                [titleKey]="homeRevisionTitleKey()"
              ></app-content-revisions>
            </div>
          </details>
        </section>
        ...
        >
          <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">
              {{ 'adminUi.home.collections.title' | translate }}
            </h2>
            <app-button
              size="sm"
              variant="ghost"
              [label]="'adminUi.actions.reset' | translate"
              (action)="resetCollectionForm()"
            ></app-button>
          </div>
          <div class="grid md:grid-cols-2 gap-3 text-sm">
            <label class="grid gap-1 text-sm font-medium text-slate-700 dark:text-slate-200">
              ...
              <div
                class="h-10 rounded-lg border border-slate-200 bg-slate-50 px-3 flex items-center font-mono text-xs text-slate-700 dark:border-slate-700 dark:bg-slate-950/30 dark:text-slate-200"
              >
                <span *ngIf="editingCollection; else collectionSlugHint">{{
                  editingCollection
                }}</span>
            ...
            <app-input
              [label]="'adminUi.home.collections.name' | translate"
            ...
            >
              ...
              <select
                multiple
                class="rounded-lg border border-slate-200 bg-white px-3 py-2 min-h-[120px] text-slate-900 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
                [(ngModel)]="collectionForm.product_ids"
              >
          ...
          <div class="flex gap-2">
            <app-button
              [label]="
                editingCollection
                  ? ('adminUi.home.collections.update' | translate)
                  : ('adminUi.home.collections.create' | translate)
              "
              (action)="saveCollection()"
            ></app-button>
            <span
              class="text-xs text-emerald-700 dark:text-emerald-300"
              *ngIf="collectionMessage"
              >{{ collectionMessage }}</span
            >
          </div>
          <div class="grid gap-2 text-sm text-slate-700 dark:text-slate-200">
            <div
              *ngFor="let col of featuredCollections"
              class="rounded-lg border border-slate-200 p-3 flex items-center justify-between dark:border-slate-700"
            >
              <div>
        ...
        >
          <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">
              {{ 'adminUi.products.title' | translate }}
            </h2>
            <div class="flex gap-2">
              <app-button
                size="sm"
              ...
              <div class="flex items-center gap-2 text-xs">
                ...
                <app-button
                  ...
                  [disabled]="!selectedIds.size || bulkStock === null"
                  (action)="saveBulkStock()"
                ></app-button>
              </div>
            </div>
          </div>
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="py-2 font-semibold text-slate-900 dark:text-slate-50">
                    {{ product.name }}
                    <span
                      *ngIf="product.tags?.includes('bestseller')"
                      class="ml-2 text-[10px] uppercase bg-amber-100 text-amber-800 px-2 py-0.5 rounded-full"
                      >Bestseller</span
                    >
                  </td>
                  <td>{{ product.price | localizedCurrency: product.currency || 'RON' }}</td>
                  <td>
                    <span class="text-xs rounded-full bg-slate-100 px-2 py-1 dark:bg-slate-800">{{
                      product.status
                    }}</span>
                  </td>
                  ...
                  <td class="flex items-center gap-2">
                    ...
                    <app-button
                      ...
                      variant="ghost"
                      label="Save"
                      (action)="saveStock(product)"
                    ></app-button>
                  </td>
                  <td>
                    <span
                      *ngIf="product.publish_at"
                      class="text-xs text-slate-600 dark:text-slate-300"
                      >{{ product.publish_at | date: 'short' }}</span
                    >
                    <span
                      *ngIf="!product.publish_at"
                  ...
                  <td class="flex gap-2 py-2">
                    <app-button
                      size="sm"
                      variant="ghost"
                      [label]="'adminUi.products.actions.update' | translate"
                      (action)="loadProduct(product.slug)"
                    ></app-button>
                    <app-button
                      size="sm"
                      variant="ghost"
                      label="Duplicate"
                      (action)="duplicateProduct(product.slug)"
                    ></app-button>
                  </td>
                </tr>
              </tbody>
          ...
          <div
            *ngIf="upcomingProducts().length"
            class="rounded-lg border border-slate-200 p-3 text-sm text-slate-700 dark:border-slate-700 dark:text-slate-200"
          >
            <p class="font-semibold text-slate-900 dark:text-slate-50 mb-2">
              Upcoming scheduled products
            </p>
            <div
              *ngFor="let p of upcomingProducts()"
              class="flex items-center justify-between py-1 border-b border-slate-100 dark:border-slate-800 last:border-0"
            >
              <span>{{ p.name }}</span>
              <span class="text-xs text-slate-600 dark:text-slate-300"
                >Publishes {{ p.publish_at | date: 'medium' }}</span
              >
            </div>
          </div>
        </section>
        ...
        >
          ...
          <div class="grid md:grid-cols-2 gap-3 text-sm">
            ...
            ></app-input>
            <app-input
              [label]="'adminUi.products.form.slug' | translate"
              [value]="form.slug"
              [disabled]="true"
            ></app-input>
            ...
            ></app-input>
            <app-input
              [label]="'adminUi.products.form.imageUrl' | translate"
              [(value)]="form.image"
            ></app-input>
          </div>
          ...
          <div class="grid gap-2" *ngIf="productImages().length">
            ...
            <div
              *ngFor="let img of productImages()"
              class="flex items-center gap-3 rounded-lg border border-slate-200 p-2 dark:border-slate-700"
            >
              <img
                [src]="img.url"
          ...
          <p *ngIf="formMessage" class="text-sm text-emerald-700 dark:text-emerald-300">
            {{ formMessage }}
          </p>
        </section>
        ...
        >
          ...
          >
            ...
            <div *ngIf="taxGroupsLoading" class="text-sm text-slate-600 dark:text-slate-300">
              {{ 'adminUi.actions.loading' | translate }}
            </div>
            ...
            <div *ngIf="!taxGroupsLoading" class="grid gap-3">
              ...
              >
                ...
                <div class="grid gap-2 md:grid-cols-4">
                  <app-input
                    [label]="'adminUi.taxes.code' | translate"
                    [(value)]="taxGroupCreate.code"
                  ></app-input>
                  <app-input
                    [label]="'adminUi.taxes.name' | translate"
                    [(value)]="taxGroupCreate.name"
                  ></app-input>
                  <app-input
                    [label]="'adminUi.taxes.description' | translate"
                    [(value)]="taxGroupCreate.description"
                  ></app-input>
                  <label class="flex items-center gap-2 text-sm text-slate-700 dark:text-slate-200">
                ...
                <div class="flex justify-end">
                  <app-button
                    size="sm"
                    [label]="'adminUi.taxes.create' | translate"
                    ...
                    <p class="text-xs text-slate-500 dark:text-slate-400">
                      ...
                      <span
                        *ngIf="group.is_default"
                        class="ml-2 rounded-full bg-emerald-100 px-2 py-0.5 text-[10px] font-semibold uppercase text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-200"
                      >
                        {{ 'adminUi.taxes.default' | translate }}
                      </span>
                    </p>
                ...
                <div class="grid gap-2">
                  ...
                  <div class="grid gap-2 md:grid-cols-[140px_160px_auto] items-end">
                    ...
                    <div class="flex justify-end">
                      <app-button
                        size="sm"
                        [label]="'adminUi.taxes.addRate' | translate"
                        (action)="upsertTaxRate(group)"
                      ></app-button>
                    </div>
                  </div>
                </div>
          ...
          >
            ...
            <div *ngIf="fxAuditLoading()" class="text-sm text-slate-600 dark:text-slate-300">
              {{ 'adminUi.actions.loading' | translate }}
            </div>

            <div
              *ngIf="!fxAuditLoading() && fxAudit().length === 0"
              class="text-sm text-slate-600 dark:text-slate-300"
            >
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="px-3 py-2 font-semibold text-slate-900 dark:text-slate-50">
                      {{ fxAuditActionLabel(entry.action) }}
                    </td>
                    <td class="px-3 py-2 text-slate-700 dark:text-slate-200">
        ...
        >
          <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">
              {{ 'adminUi.orders.title' | translate }}
            </h2>
          ...
          <div class="grid md:grid-cols-[1.5fr_1fr] gap-4">
            <div class="grid gap-2 text-sm text-slate-700 dark:text-slate-200">
              <div
                *ngFor="let order of filteredOrders()"
                class="rounded-lg border border-slate-200 p-3 cursor-pointer dark:border-slate-700"
            ...
            <div
              class="rounded-lg border border-slate-200 p-4 text-sm text-slate-700 dark:border-slate-700 dark:text-slate-200"
              *ngIf="activeOrder"
            >
              <div class="flex items-center justify-between">
                <h3 class="font-semibold text-slate-900 dark:text-slate-50">
                ...
                <select
                  ...
                  [ngModel]="activeOrder.status"
                  (ngModelChange)="changeOrderStatus($event)"
                >
                  <option value="pending_payment">
                    {{ 'adminUi.orders.pending_payment' | translate }}
                  </option>
              ...
              <p class="text-xs text-slate-500 dark:text-slate-400">
                Placed: {{ activeOrder.created_at | date: 'medium' }}
              </p>
              <p class="font-semibold text-slate-900 dark:text-slate-50 mt-2">
                {{ activeOrder.total_amount | localizedCurrency: activeOrder.currency || 'RON' }}
              </p>
            </div>
          </div>
        </section>
            ...
            >
              ...
              <div class="flex items-center gap-2 text-xs">
                <input
                  ...
                  (ngModelChange)="onSelectedUserIdChange($event)"
                />
                <select
                  class="rounded border border-slate-200 bg-white px-2 py-1 text-slate-900 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
                  [ngModel]="user.role"
                ...
                >
                  ...
                  <option *ngIf="user.role === 'owner'" value="owner">
          ...
          >
            <div class="flex items-center justify-between gap-2">
              ...
              <app-button
                ...
                variant="ghost"
                label="Refresh"
                (action)="loadUserAliases(selectedUserId!)"
              ></app-button>
            </div>
            ...
            <div
              *ngIf="userAliases"
              class="mt-3 grid gap-3 sm:grid-cols-2 text-sm text-slate-700 dark:text-slate-200"
            >
              <div
                class="rounded-lg border border-slate-200 bg-white p-3 dark:border-slate-800 dark:bg-slate-900"
              >
                ...
                <ul
                  *ngIf="userAliases.usernames?.length; else noAdminUsernamesTpl"
                  class="mt-2 grid gap-2"
                >
                  <li
                    *ngFor="let h of userAliases.usernames"
              ...
              >
                ...
                <ul
                  *ngIf="userAliases.display_names?.length; else noAdminDisplayNamesTpl"
                  class="mt-2 grid gap-2"
                >
                  <li
                    *ngFor="let h of userAliases.display_names"
                    class="flex items-center justify-between gap-2"
                  >
                    <span class="font-medium text-slate-900 dark:text-slate-50 truncate"
        ...
        >
          <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">
              {{ 'adminUi.content.title' | translate }}
            </h2>
          </div>
          <div class="grid gap-2 text-sm text-slate-700 dark:text-slate-200">
            <div
              *ngFor="let c of contentBlocks"
              class="flex items-center justify-between rounded-lg border border-slate-200 p-3 dark:border-slate-700"
            >
              <div>
                <p class="font-semibold text-slate-900 dark:text-slate-50">{{ c.title }}</p>
                <p class="text-xs text-slate-500 dark:text-slate-400">
                  {{ c.key }} · v{{ c.version }} · {{ c.updated_at | date: 'short' }}
                </p>
              </div>
              <app-button
                size="sm"
                variant="ghost"
                [label]="'adminUi.actions.edit' | translate"
                (action)="selectContent(c)"
              ></app-button>
            </div>
          </div>
          <div
            *ngIf="selectedContent"
            class="grid gap-2 pt-3 border-t border-slate-200 dark:border-slate-800"
          >
            <p class="text-sm font-semibold text-slate-900 dark:text-slate-50">
              {{ 'adminUi.content.editing' | translate }}: {{ selectedContent.key }}
            </p>
            <app-input
              [label]="'adminUi.content.titleLabel' | translate"
            ...
            <div
              class="grid gap-3"
              [ngClass]="
                showContentPreview && cmsPrefs.previewLayout() === 'split' ? 'lg:grid-cols-2' : ''
              "
            >
              <label class="grid gap-1 text-sm font-medium text-slate-700 dark:text-slate-200">
              ...
              <div
                class="mx-auto w-full"
                [ngClass]="cmsPreviewMaxWidthClass()"
                [class.hidden]="!showContentPreview"
              >
                <div
                  #contentPreview
                  class="markdown rounded-2xl border border-slate-200 bg-white p-3 text-sm text-slate-800 shadow-sm max-h-[520px] overflow-auto dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200"
            ...
            <div class="flex gap-2">
              <app-button
                size="sm"
                [label]="'adminUi.content.save' | translate"
                (action)="saveContent()"
              ></app-button>
              <app-button
                size="sm"
                variant="ghost"
                [label]="'adminUi.actions.cancel' | translate"
                (action)="cancelContent()"
              ></app-button>
              <label class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-300">
                <input type="checkbox" [(ngModel)]="showContentPreview" />
                {{ 'adminUi.content.livePreview' | translate }}
              </label>
            </div>
          </div>
        </section>
        ...
        >
          <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">
              {{ 'adminUi.coupons.title' | translate }}
            </h2>
          </div>
          <div class="grid gap-2 text-sm text-slate-700 dark:text-slate-200">
            <div class="grid md:grid-cols-3 gap-2 items-end">
              <app-input
                [label]="'adminUi.coupons.code' | translate"
                [(value)]="newCoupon.code"
              ></app-input>
              <app-input
                [label]="'adminUi.coupons.percentOff' | translate"
                type="number"
                [(value)]="newCoupon.percentage_off"
              ></app-input>
              <app-button
                size="sm"
                [label]="'adminUi.coupons.add' | translate"
                (action)="createCoupon()"
              ></app-button>
            </div>
            <div
            ...
            >
              <div>
                ...
                <p class="text-xs text-slate-500 dark:text-slate-400">
                  <ng-container *ngIf="coupon.percentage_off"
                    >-{{ coupon.percentage_off }}%</ng-container
                  >
                  <ng-container *ngIf="coupon.amount_off"
                    >-{{
                      coupon.amount_off | localizedCurrency: coupon.currency || 'RON'
                    }}</ng-container
                  >
                  <ng-container *ngIf="!coupon.percentage_off && !coupon.amount_off">{{
                    'adminUi.coupons.none' | translate
                  }}</ng-container>
                </p>
              </div>
              <div class="flex items-center gap-2">
                <app-button
                  size="sm"
                  variant="ghost"
                  [label]="'adminUi.coupons.invalidateStripe' | translate"
                  (action)="invalidateCouponStripe(coupon)"
                ></app-button>
                <button
                  type="button"
                ...
                >
                  {{
                    coupon.active
                      ? ('adminUi.coupons.active' | translate)
                      : ('adminUi.coupons.inactive' | translate)
                  }}
                </button>
              </div>
            </div>
        ...
        >
          <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div class="grid gap-0.5">
              <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">
                {{ 'adminUi.fx.title' | translate }}
              </h2>
              <p class="text-xs text-slate-500 dark:text-slate-400">
                {{ 'adminUi.fx.hint' | translate }}
              </p>
            </div>
            <app-button
              size="sm"
          ...
          <div *ngIf="fxLoading()" class="text-sm text-slate-600 dark:text-slate-300">
            {{ 'adminUi.fx.loading' | translate }}
          </div>

          <div
            *ngIf="fxStatus() as fx"
            class="grid gap-4 md:grid-cols-3 text-sm text-slate-700 dark:text-slate-200"
          >
              ...
              <div class="mt-2 grid gap-1">
                <div class="flex items-center justify-between gap-3">
                  ...
                  <span class="font-medium text-slate-900 dark:text-slate-50">{{
                    fx.effective.eur_per_ron | number: '1.4-6'
                  }}</span>
                </div>
                <div class="flex items-center justify-between gap-3">
                  <span>{{ 'adminUi.fx.usdPerRon' | translate }}</span>
                  <span class="font-medium text-slate-900 dark:text-slate-50">{{
                    fx.effective.usd_per_ron | number: '1.4-6'
                  }}</span>
                </div>
                <div class="flex items-center justify-between gap-3">
                ...
                <div class="flex items-center justify-between gap-3">
                  ...
                  <span class="text-slate-600 dark:text-slate-300">{{
                    fx.effective.fetched_at | date: 'short'
                  }}</span>
                </div>
                <div class="flex items-center justify-between gap-3">
            ...
            <div class="rounded-xl border border-slate-200 p-3 dark:border-slate-700">
              ...
              <ng-container *ngIf="fx.override; else noOverrideTpl">
                <div class="mt-2 grid gap-1">
                  <div class="flex items-center justify-between gap-3">
                    <span>{{ 'adminUi.fx.eurPerRon' | translate }}</span>
                    <span class="font-medium text-slate-900 dark:text-slate-50">{{
                      fx.override?.eur_per_ron | number: '1.4-6'
                    }}</span>
                  </div>
                  <div class="flex items-center justify-between gap-3">
                    <span>{{ 'adminUi.fx.usdPerRon' | translate }}</span>
                    <span class="font-medium text-slate-900 dark:text-slate-50">{{
                      fx.override?.usd_per_ron | number: '1.4-6'
                    }}</span>
                  </div>
                  <div class="flex items-center justify-between gap-3">
                    <span>{{ 'adminUi.fx.asOf' | translate }}</span>
                  ...
                  <div class="flex items-center justify-between gap-3">
                    <span>{{ 'adminUi.fx.fetchedAt' | translate }}</span>
                    <span class="text-slate-600 dark:text-slate-300">{{
                      fx.override?.fetched_at | date: 'short'
                    }}</span>
                  </div>
                </div>
              </ng-container>
              <ng-template #noOverrideTpl>
                <p class="mt-2 text-slate-500 dark:text-slate-400">
                  {{ 'adminUi.fx.noOverride' | translate }}
                </p>
              </ng-template>
              ...
              <div class="mt-4 grid gap-2 border-t border-slate-200 pt-4 dark:border-slate-800">
                <div class="grid gap-2 sm:grid-cols-2">
                  <app-input
                    [label]="'adminUi.fx.eurPerRon' | translate"
                    type="number"
                    [(value)]="fxOverrideForm.eur_per_ron"
                  ></app-input>
                  <app-input
                    [label]="'adminUi.fx.usdPerRon' | translate"
                    type="number"
                    [(value)]="fxOverrideForm.usd_per_ron"
                  ></app-input>
                </div>
                <label class="grid gap-1 text-sm font-medium text-slate-700 dark:text-slate-200">
                  <span>{{ 'adminUi.fx.asOf' | translate }}</span>
                  ...
                  />
                  <span class="text-xs text-slate-500 dark:text-slate-400">{{
                    'adminUi.fx.asOfHint' | translate
                  }}</span>
                </label>
                <div class="flex flex-wrap items-center gap-2">
                  <app-button
                    size="sm"
                    [label]="'adminUi.fx.actions.set' | translate"
                    (action)="saveFxOverride()"
                  ></app-button>
                  <app-button
                    size="sm"
                    variant="ghost"
                    [label]="'adminUi.fx.actions.reset' | translate"
                    (action)="resetFxOverrideForm()"
                  ></app-button>
                </div>
              </div>
            </div>
            ...
            <div class="rounded-xl border border-slate-200 p-3 dark:border-slate-700">
              ...
              <ng-container *ngIf="fx.last_known; else noLastKnownTpl">
                <div class="mt-2 grid gap-1">
                  <div class="flex items-center justify-between gap-3">
                    <span>{{ 'adminUi.fx.eurPerRon' | translate }}</span>
                    <span class="font-medium text-slate-900 dark:text-slate-50">{{
                      fx.last_known?.eur_per_ron | number: '1.4-6'
                    }}</span>
                  </div>
                  <div class="flex items-center justify-between gap-3">
                    <span>{{ 'adminUi.fx.usdPerRon' | translate }}</span>
                    <span class="font-medium text-slate-900 dark:text-slate-50">{{
                      fx.last_known?.usd_per_ron | number: '1.4-6'
                    }}</span>
                  </div>
                  <div class="flex items-center justify-between gap-3">
                    <span>{{ 'adminUi.fx.asOf' | translate }}</span>
                  ...
                  <div class="flex items-center justify-between gap-3">
                    <span>{{ 'adminUi.fx.fetchedAt' | translate }}</span>
                    <span class="text-slate-600 dark:text-slate-300">{{
                      fx.last_known?.fetched_at | date: 'short'
                    }}</span>
                  </div>
                  <div class="flex items-center justify-between gap-3">
                    <span>{{ 'adminUi.fx.source' | translate }}</span>
                    <span class="text-slate-600 dark:text-slate-300">{{
                      fx.last_known?.source
                    }}</span>
                  </div>
                </div>
              </ng-container>
              <ng-template #noLastKnownTpl>
                <p class="mt-2 text-slate-500 dark:text-slate-400">
                  {{ 'adminUi.fx.noLastKnown' | translate }}
                </p>
              </ng-template>
            </div>
          </div>
        ...
        >
          ...
          <div class="grid md:grid-cols-3 gap-4 text-sm text-slate-700 dark:text-slate-200">
            <div class="grid gap-2">
              ...
              <div
                *ngFor="let log of productAudit"
                class="rounded-lg border border-slate-200 p-3 dark:border-slate-700"
              >
                <p class="font-semibold text-slate-900 dark:text-slate-50">{{ log.action }}</p>
                <p class="text-xs text-slate-500 dark:text-slate-400">
                  {{ 'adminUi.audit.productId' | translate }} {{ log.product_id }}
                </p>
                <p class="text-xs text-slate-500 dark:text-slate-400">
                  {{ 'adminUi.audit.at' | translate }} {{ log.created_at | date: 'short' }}
                </p>
              </div>
            </div>
            <div class="grid gap-2">
              ...
              <div
                *ngFor="let log of contentAudit"
                class="rounded-lg border border-slate-200 p-3 dark:border-slate-700"
              >
                <p class="font-semibold text-slate-900 dark:text-slate-50">{{ log.action }}</p>
                <p class="text-xs text-slate-500 dark:text-slate-400">
                  {{ 'adminUi.audit.blockId' | translate }} {{ log.block_id }}
                </p>
                <p class="text-xs text-slate-500 dark:text-slate-400">
                  {{ 'adminUi.audit.at' | translate }} {{ log.created_at | date: 'short' }}
                </p>
            ...
            <div class="grid gap-2">
              ...
              <div
                *ngFor="let log of securityAudit"
                class="rounded-lg border border-slate-200 p-3 dark:border-slate-700"
              >
                <p class="font-semibold text-slate-900 dark:text-slate-50">
                  {{ 'adminUi.audit.securityActions.' + log.action | translate }}
                </p>
                <p class="text-xs text-slate-500 dark:text-slate-400">
                  {{ 'adminUi.audit.actor' | translate }} {{ log.actor_email || log.actor_user_id }}
                </p>
                <p class="text-xs text-slate-500 dark:text-slate-400">
                  {{ 'adminUi.audit.subject' | translate }}
                  {{ log.subject_email || log.data?.identifier || log.subject_user_id }}
                </p>
                <p class="text-xs text-slate-500 dark:text-slate-400">
                  {{ 'adminUi.audit.at' | translate }} {{ log.created_at | date: 'short' }}
                </p>
        ...
        >
          <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">
              {{ 'adminUi.maintenance.title' | translate }}
            </h2>
            <app-button
              size="sm"
              [label]="'adminUi.actions.save' | translate"
          ...
          <div class="flex items-center gap-3 text-sm">
            <label class="flex items-center gap-2">
              <input type="checkbox" [(ngModel)]="maintenanceEnabledValue" />
              {{ 'adminUi.maintenance.mode' | translate }}
            </label>
            <a
              ...
              target="_blank"
              rel="noopener"
              >{{ 'adminUi.maintenance.sitemap' | translate }}</a
            >
            <a
              class="text-indigo-600 dark:text-indigo-300"
              href="/robots.txt"
              target="_blank"
              rel="noopener"
              >{{ 'adminUi.maintenance.robots' | translate }}</a
            >
            <a
              class="text-indigo-600 dark:text-indigo-300"
              href="/api/v1/feeds/products.json"
              target="_blank"
              rel="noopener"
              >{{ 'adminUi.maintenance.feed' | translate }}</a
            >
          </div>
        </section>
        ...
        >
          <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">
              {{ 'adminUi.lowStock.title' | translate }}
            </h2>
            <span class="text-xs text-slate-500 dark:text-slate-400">{{
              'adminUi.lowStock.hint' | translate
            }}</span>
          </div>
          <div class="grid gap-2 text-sm text-slate-700 dark:text-slate-200">
            <div
              *ngFor="let item of lowStock"
              class="flex items-center justify-between rounded-lg border border-slate-200 p-3 dark:border-slate-700"
            >
              <div>
              ...
              >
                {{
                  'adminUi.lowStock.stockWithThreshold'
                    | translate: { count: item.stock_quantity, threshold: item.threshold }
                }}
              </span>
            </div>
          </div>
          ...
          >
            ...
            <div class="mt-3 grid gap-3">
              <label class="grid gap-1 text-sm font-medium text-slate-700 dark:text-slate-200">
                ...
                >
                  <option [ngValue]="'site.assets'">
                    {{ 'adminUi.site.assets.title' | translate }}
                  </option>
                  <option [ngValue]="'site.social'">
                    {{ 'adminUi.site.social.title' | translate }}
                  </option>
                  <option [ngValue]="'site.company'">
                    {{ 'adminUi.site.company.title' | translate }}
                  </option>
                  <option [ngValue]="'site.navigation'">
                    {{ 'adminUi.site.navigation.title' | translate }}
                  </option>
                  <option [ngValue]="'site.checkout'">
                    {{ 'adminUi.site.checkout.title' | translate }}
                  </option>
                  <option [ngValue]="'site.reports'">
                    {{ 'adminUi.reports.title' | translate }}
                  </option>
                  <option [ngValue]="'seo.' + seoPage">
                    {{ ('adminUi.site.seo.title' | translate) + ' · ' + seoPage.toUpperCase() }}
                  </option>
                </select>
              </label>
              <app-content-revisions
                [contentKey]="settingsRevisionKey"
                [titleKey]="settingsRevisionTitleKey()"
              ></app-content-revisions>
            </div>
          </details>
        </section>
...
export class AdminComponent implements OnInit, OnDestroy {
  ...
  fxOverrideForm: { eur_per_ron: number; usd_per_ron: number; as_of: string } = {
    eur_per_ron: 0,
    usd_per_ron: 0,
    as_of: '',
  };
  ...
  private applyPageDraftState(pageKey: PageBuilderKey, draft: PageBlocksDraftState): void {
    const safePageKey = this.safePageRecordKey(pageKey);
    this.pageBlocks[safePageKey] = Array.isArray(draft?.blocks)
      ? draft.blocks.map((b) => this.normalizePageBlockDraft(b))
      : [];
    this.pageBlocksStatus[safePageKey] =
      draft?.status === 'published' ? 'published' : draft?.status === 'review' ? 'review' : 'draft';
  ...
  private rememberContentVersion(
    key: string,
  ...
  private withExpectedVersion<T extends Record<string, unknown>>(
    key: string,
    payload: T,
  ...
  private handleContentConflict(err: any, key: string, reload: () => void): boolean {
    ...
    const safeKey = this.safeRecordKey(key);
    this.toast.error(
      this.t('adminUi.content.errors.conflictTitle'),
      this.t('adminUi.content.errors.conflictCopy'),
    );
  ...
  private normalizeSection(value: unknown): AdminContentSection {
    if (value === 'home' || value === 'pages' || value === 'blog' || value === 'settings')
      return value;
    return 'home';
  }
  ...
  private loadForSection(section: AdminContentSection): void {
    ...
    if (section === 'home') {
      this.admin
        .products()
        .subscribe({ next: (p) => (this.products = p), error: () => (this.products = []) });
      this.loadSections();
    ...
    this.admin
      .coupons()
      .subscribe({ next: (c) => (this.coupons = c), error: () => (this.coupons = []) });
    this.admin
      .lowStock()
      .subscribe({ next: (items) => (this.lowStock = items), error: () => (this.lowStock = []) });
    this.admin.audit().subscribe({
      ...
      error: () =>
        this.toast.error(
          this.t('adminUi.audit.errors.loadTitle'),
          this.t('adminUi.audit.errors.loadCopy'),
        ),
    });
    this.loadCategories();
    this.loadTaxGroups();
  ...
  submitOwnerTransfer(): void {
    ...
    this.admin.transferOwner({ identifier, confirm, password }).subscribe({
      next: () => {
        this.toast.success(
          this.t('adminUi.ownerTransfer.successTitle'),
          this.t('adminUi.ownerTransfer.successCopy'),
        );
      ...
      error: (err) => {
        ...
        this.ownerTransferError =
          typeof detail === 'string' && detail
            ? detail
            : this.t('adminUi.ownerTransfer.errors.generic');
  ...
  createTaxGroup(): void {
    ...
    this.taxesAdmin
      ...
      .subscribe({
        ...
        error: (err) =>
          this.toast.error(err?.error?.detail || this.t('adminUi.taxes.errors.create')),
      });
  }
  ...
  saveTaxGroup(group: TaxGroupRead): void {
    ...
    this.taxesAdmin
      ...
      .subscribe({
        ...
        error: (err) =>
          this.toast.error(err?.error?.detail || this.t('adminUi.taxes.errors.update')),
      });
  }
  ...
  upsertTaxRate(group: TaxGroupRead): void {
    ...
    this.taxesAdmin
      .upsertRate(group.id, { country_code: rawCountry, vat_rate_percent: vat })
      .subscribe({
        next: () => {
  ...
  async saveBulkStock(): Promise<void> {
    ...
    const tasks = Array.from(this.selectedIds).map((id) => {
      ...
      return firstValueFrom(
        this.admin.updateProduct(prod.slug, { stock_quantity: this.bulkStock! } as any),
      ).then(() => {
  ...
  upcomingProducts(): AdminProduct[] {
    ...
    return this.products
      ...
      .sort(
        (a, b) => new Date(a.publish_at || 0).getTime() - new Date(b.publish_at || 0).getTime(),
      );
  }
  ...
  invalidateCouponStripe(coupon: AdminCoupon): void {
    this.admin.invalidateCouponStripeMappings(coupon.id).subscribe({
      next: (res) => {
        this.toast.success(
          this.t('adminUi.coupons.success.invalidateStripe', { count: res.deleted_mappings }),
        );
      },
  ...
  saveContent(): void {
    ...
    this.admin.updateContentBlock(key, payload).subscribe({
      ...
      error: (err) => {
        if (this.handleContentConflict(err, key, () => this.selectContent(this.selectedContent!)))
          return;
  ...
  private parseNavigationLinks(
    value: unknown,
  ): Array<{ id: string; url: string; label: LocalizedText }> {
  ...
  loadNavigation(): void {
    ...
    this.admin.getContent('site.navigation').subscribe({
      next: (block) => {
        ...
        const footer_handcrafted_links = this.parseNavigationLinks(
          meta['footer_handcrafted_links'],
        );
  ...
  removeNavigationLink(list: 'header' | 'footer_handcrafted' | 'footer_legal', id: string): void {
    ...
    if (!key) return;
    if (list === 'header') {
      this.navigationForm.header_links = this.navigationForm.header_links.filter(
        (l) => l.id !== key,
      );
      return;
    }
    if (list === 'footer_handcrafted') {
      this.navigationForm.footer_handcrafted_links =
        this.navigationForm.footer_handcrafted_links.filter((l) => l.id !== key);
      return;
    }
    this.navigationForm.footer_legal_links = this.navigationForm.footer_legal_links.filter(
      (l) => l.id !== key,
    );
  }

  moveNavigationLink(
    list: 'header' | 'footer_handcrafted' | 'footer_legal',
    id: string,
    delta: number,
  ): void {
    const key = (id || '').trim();
  ...
  saveNavigation(): void {
    ...
    this.admin
      .updateContentBlock('site.navigation', this.withExpectedVersion('site.navigation', payload))
      .subscribe({
        next: (block) => onSuccess(block),
        error: (err) => {
  ...
  private setPageHidden(key: string, hidden: boolean): void {
    ...
    this.admin.getContent(target).subscribe({
      next: (block) => {
        ...
        const currentMeta = ((block as { meta?: Record<string, unknown> | null }).meta ||
        ...
        this.admin.updateContentBlock(target, payload).subscribe({
          next: (updated) => {
            ...
            this.toast.success(
              hidden
                ? this.t('adminUi.site.pages.visibility.hidden')
                : this.t('adminUi.site.pages.visibility.visible'),
            );
            this.loadContentPages();
  ...
  togglePageNeedsTranslation(pageKey: PageBuilderKey, lang: UiLang, event: Event): void {
    ...
    const payload =
      lang === 'en' ? { needs_translation_en: checked } : { needs_translation_ro: checked };
  ...
  loadContentPages(): void {
    ...
    this.admin.listContentPages().subscribe({
      next: (pages) => {
        this.contentPages = [...(pages || [])].sort((a, b) =>
  ...
  loadReusableBlocks(): void {
    ...
    this.admin.getContent(this.reusableBlocksKey).subscribe({
      next: (block) => {
        ...
        this.reusableBlocksMeta = ((block as { meta?: Record<string, unknown> | null }).meta ||
          {}) as Record<string, unknown>;
  ...
  savePageBlockAsReusable(pageKey: PageBuilderKey, blockKey: string): void {
    ...
    const defaultTitle =
      (target.title?.[this.infoLang] || target.title?.en || target.title?.ro || '').trim() ||
      this.pageBlockLabel(target);
    const title = (
      window.prompt(this.t('adminUi.content.reusableBlocks.prompts.name'), defaultTitle) || ''
    ).trim();
    if (!title) return;
    ...
    if (existing) {
      const ok = window.confirm(
        this.t('adminUi.content.reusableBlocks.prompts.overwriteConfirm', {
    ...
    const updated = existing
      ? this.reusableBlocks.map((b) => (b.id === idBase ? next : b))
      : [...this.reusableBlocks, next];
    this.persistReusableBlocks(updated, {
  ...
  insertReusableBlockIntoPage(pageKey: PageBuilderKey, id: string): void {
    ...
    const draft = {
      ...
      key: nextKey,
      enabled: true,
      layout: this.toCmsBlockLayout(snapshot.layout),
    } satisfies PageBlockDraft;
    current.push(draft);
  ...
  deleteReusableBlock(id: string): void {
    ...
    if (!found) return;
    const ok = window.confirm(
      this.t('adminUi.content.reusableBlocks.prompts.deleteConfirm', { title: found.title }),
    );
    if (!ok) return;
    const updated = this.reusableBlocks.filter((b) => b.id !== id);
    this.persistReusableBlocks(updated, {
      successKey: 'adminUi.content.reusableBlocks.success.deleted',
    });
  }
  ...
  private persistReusableBlocks(next: CmsReusableBlock[], opts?: { successKey?: string }): void {
    ...
    const onSaved = (
      block: { version?: number; meta?: Record<string, unknown> | null } | null | undefined,
    ) => {
      this.rememberContentVersion(this.reusableBlocksKey, block);
      this.reusableBlocksMeta = ((block as { meta?: Record<string, unknown> | null }).meta ||
        {}) as Record<string, unknown>;
    ...
    const onError = (err: any) => {
      if (this.handleContentConflict(err, this.reusableBlocksKey, () => this.loadReusableBlocks()))
        return;
    ...
    if (this.reusableBlocksExists) {
      this.admin
        .updateContentBlock(this.reusableBlocksKey, payload)
    ...
    this.admin
      .createContent(this.reusableBlocksKey, createPayload)
      .subscribe({ next: onSaved, error: onError });
  }

  private parseReusableBlocks(
  ...
  loadPageBlocks(pageKey: PageBuilderKey): void {
    ...
    this.admin.getContent(safePageKey).subscribe({
      next: (block) => {
        ...
        const metaObj = ((block as { meta?: Record<string, unknown> | null }).meta || {}) as Record<
          string,
          unknown
        >;
        this.setPageRecordValue(this.pageBlocksMeta, safePageKey, metaObj);
        this.setPageRecordValue(
          this.pageBlocksRequiresAuth,
          safePageKey,
          Boolean(metaObj['requires_auth']),
        );
      ...
      error: (err) => {
        ...
        this.setPageRecordValue(
          ...
          safePageKey,
          this.t('adminUi.site.pages.builder.errors.load'),
        );
      },
    });
  }
  ...
  createCustomPage(): void {
    ...
    if (this.isReservedPageSlug(baseSlug)) {
      this.toast.error(
        this.t('adminUi.site.pages.errors.reservedTitle'),
        this.t('adminUi.site.pages.errors.reservedCopy'),
      );
      return;
    }
  ...
  private findReplacePayloadKey(payload: {
    find: string;
    replace: string;
  ...
  applyFindReplace(): void {
    ...
    if (!window.confirm(this.t('adminUi.content.findReplace.confirms.apply', { items, matches })))
      return;
  ...
  private parsePageBlocksDraft(meta: Record<string, unknown> | null | undefined): PageBlockDraft[] {
    ...
    for (const [idx, raw] of rawBlocks.entries()) {
      ...
      const draft: PageBlockDraft = {
        ...
        cta_new_tab: false,
        faq_items: [
          { question: this.emptyLocalizedText(), answer_markdown: this.emptyLocalizedText() },
        ],
        testimonials: [
          {
      ...
      if (typeRaw === 'text') {
        ...
        const sourceRaw =
          typeof rec['source'] === 'string' ? String(rec['source']).trim().toLowerCase() : '';
        draft.product_grid_source =
          sourceRaw === 'collection'
            ? 'collection'
            : sourceRaw === 'products'
              ? 'products'
              : 'category';
        draft.product_grid_category_slug =
          typeof rec['category_slug'] === 'string' ? String(rec['category_slug']).trim() : '';
        draft.product_grid_collection_slug =
          typeof rec['collection_slug'] === 'string' ? String(rec['collection_slug']).trim() : '';
        ...
        draft.product_grid_limit = Number.isFinite(desired)
          ? Math.max(1, Math.min(24, Math.trunc(desired)))
          : 6;
      } else if (typeRaw === 'form') {
        const formTypeRaw =
          typeof rec['form_type'] === 'string' ? String(rec['form_type']).trim().toLowerCase() : '';
        draft.form_type = formTypeRaw === 'newsletter' ? 'newsletter' : 'contact';
        const topicRaw =
          typeof rec['topic'] === 'string' ? String(rec['topic']).trim().toLowerCase() : '';
        draft.form_topic =
          topicRaw === 'support' || topicRaw === 'refund' || topicRaw === 'dispute'
            ? (topicRaw as CmsContactTopic)
            : 'contact';
  ...
  private applyStarterTemplateToCustomBlock(
    type: CmsBlockLibraryBlockType,
    block: PageBlockDraft | HomeBlockDraft,
  ): void {
    if (type === 'text') {
    ...
    if (type === 'cta') {
      ...
      block.body_markdown = {
        en: 'Add a short message and a button.',
        ro: 'Adaugă un mesaj scurt și un buton.',
      };
      ...
      block.faq_items = [
        {
          ...
          answer_markdown: {
            ...
            ro: 'De obicei 1–3 zile lucrătoare.',
          },
        },
        {
          question: { en: 'Can I return an item?', ro: 'Pot returna un produs?' },
          answer_markdown: {
            en: 'Yes. Please contact us for details.',
            ro: 'Da. Te rugăm să ne contactezi pentru detalii.',
          },
        },
      ];
      return;
    ...
    if (type === 'testimonials') {
      ...
      block.testimonials = [
        {
          quote_markdown: {
            en: '“Amazing quality and fast delivery.”',
            ro: '„Calitate excelentă și livrare rapidă.”',
          },
  ...
  private readCmsBlockPayload(event: DragEvent): {
    scope: 'home' | 'page';
    type: CmsBlockLibraryBlockType;
    template: CmsBlockLibraryTemplate;
  } | null {
  ...
  removePageBlock(pageKey: PageBuilderKey, blockKey: string): void {
    const safePageKey = this.safePageRecordKey(pageKey);
    this.pageBlocks[safePageKey] = (this.pageBlocks[safePageKey] || []).filter(
      (b) => b.key !== blockKey,
    );
  }
  ...
  private lastUploadedContentImage(
    block: any,
  ): { url: string; focal_x: number; focal_y: number } | null {
  ...
  private contentTitleForKey(key: string): string {
    const value = (key || '').trim();
    return (
      this.contentPages.find((p) => p.key === value)?.title ||
      cmsGlobalSectionDefaultTitle(value) ||
      value ||
      'Content'
    );
  }

  private async uploadCmsImageToKey(
    contentKey: string,
    file: File,
  ): Promise<{ url: string; focal_x: number; focal_y: number } | null> {
    try {
  ...
  private async insertPageMediaFiles(
    pageKey: PageBuilderKey,
    index: number,
    files: File[],
  ): Promise<void> {
  ...
  searchProductGridProducts(blockKey: string): void {
    ...
    this.adminProducts.search({ q: query, limit: 8, page: 1 }).subscribe({
      ...
      error: () => {
        this.productGridProductSearchResults[blockKey] = [];
        this.productGridProductSearchLoading[blockKey] = false;
        this.productGridProductSearchError[blockKey] = this.t(
  ...
  private buildPageBlocksMeta(pageKey: PageBuilderKey): Record<string, unknown> {
    const blocks = (this.pageBlocks[pageKey] || []).map((b) => {
      ...
      if (b.type === 'text') {
        ...
        base['columns'] = (b.columns || [])
          .slice(0, 3)
          .map((col) => ({ title: col.title, body_markdown: col.body_markdown }));
        ...
        base['items'] = (b.faq_items || [])
          .slice(0, 20)
          .map((item) => ({ question: item.question, answer_markdown: item.answer_markdown }));
        ...
        const limit = Math.max(
          1,
          Math.min(24, Number.isFinite(desiredLimit) ? Math.trunc(desiredLimit) : 6),
        );
        base['limit'] = limit;
  ...
  private computePagePublishChecklistLocal(
    pageKey: PageBuilderKey,
  ): Pick<CmsPublishChecklistResult, 'missingTranslations' | 'missingAlt' | 'emptySections'> {
    ...
    enabledBlocks.forEach((block, idx) => {
      ...
      if (block.type === 'cta') {
        ...
        if (!(titleEn || titleRo || bodyEn || bodyRo || ctaEn || ctaRo || url))
      ...
      if (block.type === 'product_grid') {
        ...
        const hasAny = (block.product_grid_product_slugs || '')
          .split(/[,\n]/g)
          .some((raw) => Boolean(raw.trim()));
        if (!hasAny) emptySections.push(label);
        return;
      }
      if (block.type === 'form') {
  ...
  openPagePublishChecklist(pageKey: PageBuilderKey): void {
    ...
    this.admin
      .linkCheckContentPreview({ key: pageKey, meta, body_markdown: '', images: [] })
      .subscribe({
        next: (resp) => {
        ...
        error: (err) => {
          this.pagePublishChecklistLoading = false;
          this.pagePublishChecklistError =
            err?.error?.detail || this.t('adminUi.content.publishChecklist.errors.linkCheck');
        },
      });
  }
  ...
  savePageBlocks(pageKey: PageBuilderKey, opts?: { bypassChecklist?: boolean }): void {
    ...
    this.admin
      .updateContentBlock(safePageKey, this.withExpectedVersion(safePageKey, payload))
      .subscribe({
        next: (block) => {
          this.rememberContentVersion(safePageKey, block);
          ...
          this.pageBlocksStatus[safePageKey] =
            block.status === 'published'
              ...
              : block.status === 'review'
                ? 'review'
                : 'draft';
          this.pageBlocksPublishedAt[safePageKey] = block.published_at
            ? this.toLocalDateTime(block.published_at)
            : '';
          this.pageBlocksPublishedUntil[safePageKey] = block.published_until
            ? this.toLocalDateTime(block.published_until)
            : '';
          this.pageBlocksMeta[safePageKey] = ((block as { meta?: Record<string, unknown> | null })
            .meta || {}) as Record<string, unknown>;
          this.pageBlocksRequiresAuth[safePageKey] = Boolean(
            this.pageBlocksMeta[safePageKey]?.['requires_auth'],
          );
          this.pageBlocksMessage[safePageKey] = ok;
          this.pageBlocksError[safePageKey] = null;
          this.ensurePageDraft(safePageKey).markServerSaved(
            this.currentPageDraftState(safePageKey),
            true,
          );
          ...
          if (err?.status === 404) {
            ...
            this.admin.createContent(safePageKey, createPayload).subscribe({
              next: (created) => {
                ...
                this.pageBlocksNeedsTranslationEn[safePageKey] = Boolean(
                  created.needs_translation_en,
                );
                this.pageBlocksNeedsTranslationRo[safePageKey] = Boolean(
                  created.needs_translation_ro,
                );
                this.pageBlocksStatus[safePageKey] =
                ...
                this.pageBlocksPublishedUntil[safePageKey] = created.published_until
                  ...
                  : '';
                this.pageBlocksMeta[safePageKey] = ((
                  created as { meta?: Record<string, unknown> | null }
                ).meta || {}) as Record<string, unknown>;
                this.pageBlocksRequiresAuth[safePageKey] = Boolean(
                  this.pageBlocksMeta[safePageKey]?.['requires_auth'],
                );
  ...
  private toCmsBlockLayout(value: unknown): CmsBlockLayout {
    ...
    const backgroundRaw =
      typeof rec['background'] === 'string' ? String(rec['background']).trim() : '';
  ...
  private toCarouselSettingsDraft(value: unknown): CarouselSettingsDraft {
    ...
    const interval =
      typeof rec['interval_ms'] === 'number' ? rec['interval_ms'] : Number(rec['interval_ms']);
    base.interval_ms =
      Number.isFinite(interval) && interval > 0 ? Math.floor(interval) : base.interval_ms;
        ...
        if (Array.isArray(rawBlocks) && rawBlocks.length) {
          ...
          for (const raw of rawBlocks) {
            ...
            if (type === 'text') {
              ...
              draft.cta_label = this.toLocalizedText(rec['cta_label']);
              draft.cta_url =
                typeof rec['cta_url'] === 'string' ? String(rec['cta_url']).trim() : '';
              draft.cta_new_tab = this.toBooleanValue(rec['cta_new_tab'], false);
            } else if (type === 'faq') {
              const itemsRaw = rec['items'];
              const items: CmsFaqItemDraft[] = [];
              ...
              draft.url = typeof rec['url'] === 'string' ? String(rec['url']).trim() : '';
              draft.link_url =
                typeof rec['link_url'] === 'string' ? String(rec['link_url']).trim() : '';
              draft.alt = this.toLocalizedText(rec['alt']);
              draft.caption = this.toLocalizedText(rec['caption']);
              draft.focal_x = this.toFocalValue(rec['focal_x']);
              draft.focal_y = this.toFocalValue(rec['focal_y']);
        ...
        if (Array.isArray(rawSections)) {
          for (const raw of rawSections) {
            ...
            addSection(
              ...
              (raw as { enabled?: unknown }).enabled === false ? false : true,
            );
          }
          if (derived.length) {
  ...
  saveSections(): void {
    ...
    this.admin
      .updateContentBlock('home.sections', this.withExpectedVersion('home.sections', payload))
      .subscribe({
        next: (block) => {
          this.rememberContentVersion('home.sections', block);
  ...
  saveCollection(): void {
    ...
    obs.subscribe({
      next: (col) => {
        ...
        if (existing) {
          this.featuredCollections = this.featuredCollections.map((c) =>
            c.slug === col.slug ? col : c,
          );
        } else {
