...
/** Golden WU shop-cmp-set-pagination-mode -- setPaginationMode. */
describe('ShopComponent setPaginationMode (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setPaginationMode(undefined as any); }).not.toThrow();
  });
});
