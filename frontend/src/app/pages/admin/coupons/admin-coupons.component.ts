  ...
  template: `
    <div class="grid gap-6">
      ...
      <app-admin-page-header
        [titleKey]="'adminUi.couponsV2.title'"
        [hintKey]="'adminUi.couponsV2.subtitle'"
      ></app-admin-page-header>
      ...
      <div class="grid gap-6 lg:grid-cols-2 items-start">
          ...
          <div class="flex items-start justify-between gap-3">
            <div class="grid gap-1">
              <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">
                {{ 'adminUi.couponsV2.promotions.title' | translate }}
              </h2>
              <p class="text-sm text-slate-600 dark:text-slate-300">
                {{ 'adminUi.couponsV2.promotions.hint' | translate }}
              </p>
            </div>
            <div class="flex items-center gap-2">
              ...
              <app-button
                size="sm"
                [label]="'adminUi.couponsV2.promotions.new' | translate"
                (action)="startNewPromotion()"
              ></app-button>
            </div>
          </div>
              ...
              >
                <div class="flex items-start justify-between gap-3">
                  ...
                  >
                    {{
                      p.is_active
                        ? ('adminUi.couponsV2.common.active' | translate)
                        : ('adminUi.couponsV2.common.inactive' | translate)
                    }}
                  </span>
                </div>
              </button>
          ...
          <div class="border-t border-slate-200 pt-4 grid gap-4 dark:border-slate-800">
            <div class="flex items-start justify-between gap-3">
              ...
              <label class="grid gap-1 text-xs font-medium text-slate-600 dark:text-slate-300">
                ...
                >
                  <option [ngValue]="30">
                    {{ 'adminUi.couponsV2.calendar.window30' | translate }}
                  </option>
                  <option [ngValue]="90">
                    {{ 'adminUi.couponsV2.calendar.window90' | translate }}
                  </option>
                  <option [ngValue]="180">
                    {{ 'adminUi.couponsV2.calendar.window180' | translate }}
                  </option>
                </select>
              </label>
            </div>
            ...
            <div class="text-xs text-slate-500 dark:text-slate-400">
              <span class="font-semibold">{{
                promotionCalendarStartDate() | date: 'yyyy-MM-dd'
              }}</span>
              <span class="px-1">→</span>
              <span class="font-semibold">{{
                promotionCalendarEndDate() | date: 'yyyy-MM-dd'
              }}</span>
            </div>

            <div
              *ngIf="promotionScheduleRows().length === 0"
              class="text-sm text-slate-600 dark:text-slate-300"
            >
              ...
              >
                ...
                >
                  <div class="flex items-center gap-2">
                    ...
                    >
                      {{
                        'adminUi.couponsV2.calendar.conflicts'
                          | translate: { count: row.conflictCount }
                      }}
                    </span>
                  </div>
                  <div class="text-xs text-slate-500 dark:text-slate-400 truncate">
                    ...
                    <span class="px-1">→</span>
                    {{
                      row.promotion.ends_at
                        ? (row.promotion.ends_at | date: 'yyyy-MM-dd')
                        : ('adminUi.couponsV2.calendar.noEnd' | translate)
                    }}
                  </div>
                </button>

                <div
                  class="relative h-10 rounded-lg bg-slate-100 dark:bg-slate-800 overflow-hidden"
                >
                  <div
          ...
          <div class="border-t border-slate-200 pt-4 grid gap-4 dark:border-slate-800">
            ...
            <div class="grid gap-3">
              <div class="grid gap-3 lg:grid-cols-2">
                <app-input
                  [label]="'adminUi.couponsV2.fields.key' | translate"
                  [(value)]="promotionForm.key"
                ></app-input>
                <app-input
                  [label]="'adminUi.couponsV2.fields.name' | translate"
                ...
                <label class="grid gap-1 text-sm font-medium text-slate-700 dark:text-slate-200">
                  ...
                  >
                    <option value="percent">
                      {{ 'adminUi.couponsV2.discountTypes.percent' | translate }}
                    </option>
                    <option value="amount">
                      {{ 'adminUi.couponsV2.discountTypes.amount' | translate }}
                    </option>
                    <option value="free_shipping">
                      {{ 'adminUi.couponsV2.discountTypes.free_shipping' | translate }}
                    </option>
                  </select>
                </label>
              ...
              <div class="grid gap-3 lg:grid-cols-2">
                ...
                >
                  <input
                    type="checkbox"
                    class="h-5 w-5 accent-indigo-600"
                    [(ngModel)]="promotionForm.is_active"
                  />
                ...
                >
                  <input
                    type="checkbox"
                    class="h-5 w-5 accent-indigo-600"
                    [(ngModel)]="promotionForm.is_automatic"
                  />
              ...
              <div class="rounded-xl border border-slate-200 p-3 grid gap-3 dark:border-slate-800">
                ...
                <div class="grid gap-3 lg:grid-cols-3 items-end">
                  ...
                  <div class="text-xs text-slate-600 dark:text-slate-300 lg:col-span-2">
                    {{
                      promotionForm.allow_on_sale_items
                        ? ('adminUi.couponsV2.stacking.saleAllowed' | translate)
                        : ('adminUi.couponsV2.stacking.saleBlocked' | translate)
                    }}
                    ·
                    {{
                ...
                <div
                  *ngIf="promotionForm.discount_type !== 'free_shipping'"
                  class="grid gap-2 text-sm"
                >
                  <div class="flex items-center justify-between gap-3">
                    <span class="text-slate-600 dark:text-slate-300">{{
                      'adminUi.couponsV2.stacking.regularItems' | translate
                    }}</span>
                    <span class="font-semibold text-slate-900 dark:text-slate-50">{{
                      formatRon(stackingPreviewProductDiscount(false))
                    }}</span>
                  </div>
                  <div class="flex items-center justify-between gap-3">
                    <span class="text-slate-600 dark:text-slate-300">{{
                      'adminUi.couponsV2.stacking.saleItems' | translate
                    }}</span>
                    <span class="font-semibold text-slate-900 dark:text-slate-50">{{
                      formatRon(stackingPreviewProductDiscount(true))
                    }}</span>
                  </div>
                </div>
                ...
                >
                  {{
                    'adminUi.couponsV2.stacking.minSubtotalWarning'
                      | translate: { min: promotionForm.min_subtotal }
                  }}
                </div>
              ...
              <div class="rounded-xl border border-slate-200 p-3 grid gap-3 dark:border-slate-800">
                ...
                <div class="grid gap-2">
                  <div class="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                    <app-input
                      [label]="'adminUi.couponsV2.scopes.searchProducts' | translate"
                      [(value)]="productQuery"
                    ></app-input>
                    <div class="flex items-center gap-2">
                      <app-button
                  ...
                  <div
                    *ngIf="!productsLoading() && products().length"
                  ...
                  <div class="grid gap-3 lg:grid-cols-2">
                    <div class="grid gap-2">
                      ...
                      <div
                        *ngIf="promotionForm.included_product_ids.length === 0"
                        class="text-sm text-slate-600 dark:text-slate-300"
                      >
                      ...
                      <div
                        ...
                        *ngIf="promotionForm.included_product_ids.length"
                      >
                        <button
                          type="button"
                    ...
                    <div class="grid gap-2">
                      ...
                      <div
                        *ngIf="promotionForm.excluded_product_ids.length === 0"
                        class="text-sm text-slate-600 dark:text-slate-300"
                      >
                        {{ 'adminUi.couponsV2.scopes.none' | translate }}
                      </div>
                      <div
                        class="flex flex-wrap gap-2"
                        *ngIf="promotionForm.excluded_product_ids.length"
                      >
                        <button
                          type="button"
              ...
              <div class="flex items-center gap-2">
                <app-button
                  ...
                  [label]="
                    selectedPromotion()
                      ? ('adminUi.couponsV2.promotions.save' | translate)
                      : ('adminUi.couponsV2.promotions.create' | translate)
                  "
                  [disabled]="promotionSaving()"
                  (action)="savePromotion()"
                ></app-button>
                <span
                  *ngIf="promotionSaving()"
                  class="text-sm text-slate-600 dark:text-slate-300"
                  >{{ 'adminUi.couponsV2.common.saving' | translate }}</span
                >
              </div>
            </div>
          </div>
        ...
        >
          <div class="flex items-start justify-between gap-3">
            <div class="grid gap-1">
              <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">
                {{ 'adminUi.couponsV2.coupons.title' | translate }}
              </h2>
              <p class="text-sm text-slate-600 dark:text-slate-300">
                {{ 'adminUi.couponsV2.coupons.hint' | translate }}
              </p>
            </div>
            <div class="flex items-center gap-2">
              <app-button
              ...
              <app-button
                size="sm"
                [label]="'adminUi.couponsV2.coupons.new' | translate"
                (action)="startNewCoupon()"
              ></app-button>
            </div>
          </div>
          ...
          <div class="grid gap-3 lg:grid-cols-[1fr_auto] items-end">
            <app-input
              [label]="'adminUi.couponsV2.coupons.search' | translate"
              [(value)]="couponQuery"
            ></app-input>
            <app-button
              size="sm"
          ...
          <ng-template #couponListTpl>
            <div *ngIf="coupons().length === 0" class="text-sm text-slate-600 dark:text-slate-300">
              {{
                selectedPromotion()
                  ? ('adminUi.couponsV2.coupons.empty' | translate)
                  : ('adminUi.couponsV2.coupons.selectPromotion' | translate)
              }}
            </div>
                ...
                <thead class="bg-slate-50 text-slate-700 dark:bg-slate-800/70 dark:text-slate-200">
                  <tr>
                    <th class="text-left font-semibold px-3 py-2">
                      {{ 'adminUi.couponsV2.coupons.table.code' | translate }}
                    </th>
                    <th class="text-left font-semibold px-3 py-2">
                      {{ 'adminUi.couponsV2.coupons.table.visibility' | translate }}
                    </th>
                    <th class="text-left font-semibold px-3 py-2">
                      {{ 'adminUi.couponsV2.coupons.table.active' | translate }}
                    </th>
                    <th class="text-left font-semibold px-3 py-2">
                      {{ 'adminUi.couponsV2.coupons.table.ends' | translate }}
                    </th>
                    <th class="text-right font-semibold px-3 py-2">
                      {{ 'adminUi.couponsV2.coupons.table.actions' | translate }}
                    </th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  >
                    <td class="px-3 py-2 font-mono text-slate-900 dark:text-slate-50">
                      {{ c.code }}
                    </td>
                    ...
                    <td class="px-3 py-2 text-slate-600 dark:text-slate-300">
                      {{ c.ends_at ? (c.ends_at | date: 'yyyy-MM-dd') : '—' }}
                    </td>
            ...
            <div class="grid gap-3">
              ...
              <div class="grid gap-3 lg:grid-cols-2">
                ...
                <label class="grid gap-1 text-sm font-medium text-slate-700 dark:text-slate-200">
                  ...
                  >
                    <option value="public">
                      {{ 'adminUi.couponsV2.coupons.visibility.public' | translate }}
                    </option>
                    <option value="assigned">
                      {{ 'adminUi.couponsV2.coupons.visibility.assigned' | translate }}
                    </option>
                  </select>
                </label>
              </div>
              ...
              <div *ngIf="!selectedCoupon()" class="grid gap-3 lg:grid-cols-4 items-end">
                <app-input
                  [label]="'adminUi.couponsV2.coupons.generator.prefix' | translate"
                  [(value)]="couponCodeGen.prefix"
                ></app-input>
                <app-input
              ...
              <div class="flex items-center gap-2">
                <app-button
                  ...
                  [label]="
                    selectedCoupon()
                      ? ('adminUi.couponsV2.coupons.save' | translate)
                      : ('adminUi.couponsV2.coupons.create' | translate)
                  "
                  [disabled]="couponSaving()"
                  (action)="saveCoupon()"
                ></app-button>
                <span *ngIf="couponSaving()" class="text-sm text-slate-600 dark:text-slate-300">{{
          ...
          <div
            *ngIf="selectedPromotion()"
            class="border-t border-slate-200 pt-4 grid gap-4 dark:border-slate-800"
          >
            <div class="flex items-start justify-between gap-3">
              <div class="grid gap-1">
                <h3 class="text-base font-semibold text-slate-900 dark:text-slate-50">
                  {{ 'adminUi.couponsV2.analytics.title' | translate }}
                </h3>
                <p class="text-sm text-slate-600 dark:text-slate-300">
                  {{ 'adminUi.couponsV2.analytics.hint' | translate }}
                </p>
              </div>
              <div class="flex flex-wrap items-end gap-3 justify-end">
                <label class="grid gap-1 text-xs font-medium text-slate-600 dark:text-slate-300">
                  ...
                  >
                    <option [ngValue]="7">
                      {{ 'adminUi.couponsV2.analytics.window7' | translate }}
                    </option>
                    <option [ngValue]="30">
                      {{ 'adminUi.couponsV2.analytics.window30' | translate }}
                    </option>
                    <option [ngValue]="90">
                      {{ 'adminUi.couponsV2.analytics.window90' | translate }}
                    </option>
                  </select>
                </label>
                <app-button
            ...
            <ng-template #analyticsTpl>
              <div
                *ngIf="!analytics() || analytics()!.summary.redemptions === 0"
                class="text-sm text-slate-600 dark:text-slate-300"
              >
              ...
              <div *ngIf="analytics()" class="grid gap-4">
                <div class="grid gap-3 lg:grid-cols-3">
                  <div
                    class="rounded-xl border border-slate-200 bg-slate-50 p-3 grid gap-1 dark:border-slate-800 dark:bg-slate-950/40"
                  >
                    <div
                      class="text-xs font-semibold tracking-wide uppercase text-slate-500 dark:text-slate-400"
                    >
                ...
                <div class="grid gap-3 lg:grid-cols-3">
                  <div
                    class="rounded-xl border border-slate-200 p-3 grid gap-1 dark:border-slate-800"
                  >
                    <div
                      class="text-xs font-semibold tracking-wide uppercase text-slate-500 dark:text-slate-400"
                    >
                ...
                <div
                  *ngIf="analytics()!.daily.length"
                  class="rounded-xl border border-slate-200 overflow-x-auto dark:border-slate-800"
                >
                  ...
                  <table class="min-w-[520px] w-full text-sm">
                    ...
                    >
                      <tr>
                        <th class="text-left font-semibold px-3 py-2">
                          {{ 'adminUi.couponsV2.analytics.daily.table.date' | translate }}
                        </th>
                        <th class="text-right font-semibold px-3 py-2">
                          {{ 'adminUi.couponsV2.analytics.daily.table.redemptions' | translate }}
                        </th>
                        <th class="text-right font-semibold px-3 py-2">
                          {{ 'adminUi.couponsV2.analytics.daily.table.discount' | translate }}
                        </th>
                      </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                      <tr *ngFor="let row of analytics()!.daily">
                        ...
                        <td class="px-3 py-2 text-right text-slate-700 dark:text-slate-200">
                          {{ formatRonString(row.discount_ron) }}
                        </td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <div
                  *ngIf="analytics()!.top_products.length"
                  class="rounded-xl border border-slate-200 overflow-x-auto dark:border-slate-800"
                >
                  <div class="px-3 py-2 text-sm font-semibold text-slate-900 dark:text-slate-50">
                  ...
                  <table class="min-w-[720px] w-full text-sm">
                    ...
                    >
                      <tr>
                        <th class="text-left font-semibold px-3 py-2">
                          {{ 'adminUi.couponsV2.analytics.topProducts.table.product' | translate }}
                        </th>
                        <th class="text-right font-semibold px-3 py-2">
                          {{ 'adminUi.couponsV2.analytics.topProducts.table.orders' | translate }}
                        </th>
                        <th class="text-right font-semibold px-3 py-2">
                          {{ 'adminUi.couponsV2.analytics.topProducts.table.quantity' | translate }}
                        </th>
                        <th class="text-right font-semibold px-3 py-2">
                          {{ 'adminUi.couponsV2.analytics.topProducts.table.gross' | translate }}
                        </th>
                        <th class="text-right font-semibold px-3 py-2">
                          {{
                            'adminUi.couponsV2.analytics.topProducts.table.allocated' | translate
                          }}
                        </th>
                      </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                      <tr *ngFor="let row of analytics()!.top_products">
                        ...
                        <td class="px-3 py-2 text-right text-slate-700 dark:text-slate-200">
                          {{ formatRonString(row.gross_sales_ron) }}
                        </td>
                        <td
                          class="px-3 py-2 text-right font-semibold text-slate-900 dark:text-slate-50"
                        >
          ...
          >
            <div class="flex items-start justify-between gap-3">
              <div class="grid gap-1">
                <h3 class="text-base font-semibold text-slate-900 dark:text-slate-50">
                  {{ 'adminUi.couponsV2.assignments.title' | translate }}
                </h3>
                <p class="text-sm text-slate-600 dark:text-slate-300">
                  {{ 'adminUi.couponsV2.assignments.hint' | translate }}
                </p>
              </div>
              <app-button
                size="sm"
            ...
            <div class="grid gap-3 lg:grid-cols-2">
              <div class="rounded-xl border border-slate-200 p-3 grid gap-3 dark:border-slate-800">
                <div class="text-sm font-semibold text-slate-900 dark:text-slate-50">
                  {{ 'adminUi.couponsV2.assignments.assignTitle' | translate }}
                </div>
                <app-input
                  [label]="'adminUi.couponsV2.assignments.email' | translate"
                  type="email"
                  [(value)]="assignEmail"
                ></app-input>
                <label
                ...
                >
                  <input
                    type="checkbox"
                    class="h-5 w-5 accent-indigo-600"
                    [(ngModel)]="assignSendEmail"
                  />
                  {{ 'adminUi.couponsV2.assignments.sendEmail' | translate }}
                </label>
                <app-button
                  size="sm"
                  [label]="'adminUi.couponsV2.assignments.assign' | translate"
                  (action)="assign()"
                ></app-button>
              </div>
              ...
              <div class="rounded-xl border border-slate-200 p-3 grid gap-3 dark:border-slate-800">
                <div class="text-sm font-semibold text-slate-900 dark:text-slate-50">
                  {{ 'adminUi.couponsV2.assignments.revokeTitle' | translate }}
                </div>
                <app-input
                  [label]="'adminUi.couponsV2.assignments.email' | translate"
                  type="email"
                ...
                ></app-input>
                <app-input
                  [label]="'adminUi.couponsV2.assignments.reason' | translate"
                  [(value)]="revokeReason"
                ></app-input>
                <label
                  class="flex items-center gap-2 text-sm font-medium text-slate-700 dark:text-slate-200"
                ...
                <app-button
                  size="sm"
                  variant="ghost"
                  [label]="'adminUi.couponsV2.assignments.revoke' | translate"
                  (action)="revoke()"
                ></app-button>
              </div>
            </div>
            ...
            <div class="rounded-xl border border-slate-200 p-3 grid gap-3 dark:border-slate-800">
              <div class="flex items-start justify-between gap-3">
                <div class="grid gap-1">
                  <div class="text-sm font-semibold text-slate-900 dark:text-slate-50">
                    {{ 'adminUi.couponsV2.bulk.title' | translate }}
                  </div>
                  <p class="text-sm text-slate-600 dark:text-slate-300">
                    {{ 'adminUi.couponsV2.bulk.hint' | translate }}
                  </p>
                </div>
                <app-button
                  size="sm"
              ...
              <app-input
                [label]="'adminUi.couponsV2.bulk.revokeReason' | translate"
              ...
              <div class="flex flex-wrap items-center gap-2">
                <app-button
                  ...
                  [label]="'adminUi.couponsV2.bulk.assign' | translate"
                  (action)="bulkAssign()"
                ></app-button>
                <app-button
                  size="sm"
                  variant="ghost"
                  [disabled]="bulkBusy() || bulkEmails.length === 0"
                  [label]="'adminUi.couponsV2.bulk.revoke' | translate"
                  (action)="bulkRevoke()"
                ></app-button>
                <span *ngIf="bulkBusy()" class="text-sm text-slate-600 dark:text-slate-300">{{
                  'adminUi.couponsV2.common.saving' | translate
                }}</span>
              </div>
              ...
              >
                <div class="font-semibold text-slate-900 dark:text-slate-50">
                  {{ 'adminUi.couponsV2.bulk.resultTitle' | translate }}
                </div>
                <div class="mt-1 grid gap-1">
                  <div *ngIf="bulkResult()!.created">
                    {{
                      'adminUi.couponsV2.bulk.resultCreated'
                        | translate: { count: bulkResult()!.created }
                    }}
                  </div>
                  <div *ngIf="bulkResult()!.restored">
                    {{
                      'adminUi.couponsV2.bulk.resultRestored'
                        | translate: { count: bulkResult()!.restored }
                    }}
                  </div>
                  <div *ngIf="bulkResult()!.already_active">
                    {{
                      'adminUi.couponsV2.bulk.resultAlreadyActive'
                        | translate: { count: bulkResult()!.already_active }
                    }}
                  </div>
                  <div *ngIf="bulkResult()!.revoked">
                    {{
                      'adminUi.couponsV2.bulk.resultRevoked'
                        | translate: { count: bulkResult()!.revoked }
                    }}
                  </div>
                  <div *ngIf="bulkResult()!.already_revoked">
                    {{
                      'adminUi.couponsV2.bulk.resultAlreadyRevoked'
                        | translate: { count: bulkResult()!.already_revoked }
                    }}
                  </div>
                  <div *ngIf="bulkResult()!.not_assigned">
                    {{
                      'adminUi.couponsV2.bulk.resultNotAssigned'
                        | translate: { count: bulkResult()!.not_assigned }
                    }}
                  </div>
                  <div *ngIf="bulkResult()!.not_found_emails?.length">
                    {{
                      'adminUi.couponsV2.bulk.resultNotFound'
                        | translate: { count: bulkResult()!.not_found_emails.length }
                    }}
                  </div>
                  <div *ngIf="bulkResult()!.invalid_emails?.length">
                    {{
                      'adminUi.couponsV2.bulk.resultInvalid'
                        | translate: { count: bulkResult()!.invalid_emails.length }
                    }}
                  </div>
                </div>
              </div>
              ...
              <div class="border-t border-slate-200 pt-4 grid gap-3 dark:border-slate-800">
                <div class="grid gap-1">
                  <div class="text-sm font-semibold text-slate-900 dark:text-slate-50">
                    {{ 'adminUi.couponsV2.bulk.segment.title' | translate }}
                  </div>
                  <p class="text-sm text-slate-600 dark:text-slate-300">
                    {{ 'adminUi.couponsV2.bulk.segment.hint' | translate }}
                  </p>
                </div>
                ...
                <div class="grid gap-2 lg:grid-cols-2">
                  ...
                  >
                    <input
                      type="checkbox"
                      class="h-5 w-5 accent-indigo-600"
                      [(ngModel)]="segmentRequireMarketingOptIn"
                    />
                  ...
                  >
                    <input
                      type="checkbox"
                      class="h-5 w-5 accent-indigo-600"
                      [(ngModel)]="segmentRequireEmailVerified"
                    />
                ...
                <div class="grid gap-3 lg:grid-cols-2">
                  ...
                  >
                    <input
                      type="checkbox"
                      class="h-5 w-5 accent-indigo-600"
                      [(ngModel)]="segmentAssignSendEmail"
                    />
                    {{ 'adminUi.couponsV2.bulk.sendEmailAssign' | translate }}
                  </label>
                  <label
                  ...
                  >
                    <input
                      type="checkbox"
                      class="h-5 w-5 accent-indigo-600"
                      [(ngModel)]="segmentRevokeSendEmail"
                    />
                    {{ 'adminUi.couponsV2.bulk.sendEmailRevoke' | translate }}
                  </label>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-2">
                  ...
                  ></app-button>
                  <span
                    *ngIf="segmentPreviewBusy() || segmentJobInProgress()"
                    class="text-sm text-slate-600 dark:text-slate-300"
                    >{{ 'adminUi.couponsV2.common.saving' | translate }}</span
                  >
                </div>
                ...
                >
                  <div class="font-semibold text-slate-900 dark:text-slate-50">
                    {{ 'adminUi.couponsV2.bulk.segment.previewTitle' | translate }}
                  </div>
                  <div class="mt-1 grid gap-1">
                    <div>
                      {{
                        'adminUi.couponsV2.bulk.segment.candidates'
                          | translate: { count: segmentCandidatesCount() }
                      }}
                    </div>
                    <div *ngIf="segmentPreviewAssign()">
                      {{
                        'adminUi.couponsV2.bulk.resultCreated'
                          | translate: { count: segmentPreviewAssign()!.created }
                      }}
                      ·
                      {{
                        'adminUi.couponsV2.bulk.resultRestored'
                          | translate: { count: segmentPreviewAssign()!.restored }
                      }}
                      ·
                      {{
                        'adminUi.couponsV2.bulk.resultAlreadyActive'
                          | translate: { count: segmentPreviewAssign()!.already_active }
                      }}
                    </div>
                    <div *ngIf="segmentPreviewRevoke()">
                      {{
                        'adminUi.couponsV2.bulk.resultRevoked'
                          | translate: { count: segmentPreviewRevoke()!.revoked }
                      }}
                      ·
                      {{
                        'adminUi.couponsV2.bulk.resultAlreadyRevoked'
                          | translate: { count: segmentPreviewRevoke()!.already_revoked }
                      }}
                      ·
                      {{
                        'adminUi.couponsV2.bulk.resultNotAssigned'
                          | translate: { count: segmentPreviewRevoke()!.not_assigned }
                      }}
                    </div>
                    <div
                      *ngIf="segmentPreviewSample()"
                      class="text-xs text-slate-500 dark:text-slate-400"
                    >
                      {{
                        'adminUi.couponsV2.bulk.segment.sample'
                          | translate: { emails: segmentPreviewSample() }
                      }}
                    </div>
                  </div>
                </div>
                ...
                >
                  <div class="flex items-center justify-between gap-3">
                    <div class="font-semibold text-slate-900 dark:text-slate-50">
                      {{ 'adminUi.couponsV2.bulk.segment.jobTitle' | translate }}
                    </div>
                    <div class="flex items-center gap-2">
                      <app-button
                      ...
                      <app-button
                        *ngIf="
                          segmentJob()!.status === 'failed' || segmentJob()!.status === 'cancelled'
                        "
                        size="xs"
                        variant="ghost"
                  ...
                  <div class="mt-1 grid gap-1">
                    <div>
                      {{
                        'adminUi.couponsV2.bulk.segment.jobStatus'
                          | translate: { status: segmentJob()!.status }
                      }}
                    </div>
                    <div>
                      {{
                        'adminUi.couponsV2.bulk.segment.jobProgress'
                          | translate
                            : {
                                processed: segmentJob()!.processed,
                                total: segmentJob()!.total_candidates,
                              }
                      }}
                    </div>
                    <div *ngIf="segmentJob()!.created">
                      {{
                        'adminUi.couponsV2.bulk.resultCreated'
                          | translate: { count: segmentJob()!.created }
                      }}
                    </div>
                    <div *ngIf="segmentJob()!.restored">
                      {{
                        'adminUi.couponsV2.bulk.resultRestored'
                          | translate: { count: segmentJob()!.restored }
                      }}
                    </div>
                    <div *ngIf="segmentJob()!.already_active">
                      {{
                        'adminUi.couponsV2.bulk.resultAlreadyActive'
                          | translate: { count: segmentJob()!.already_active }
                      }}
                    </div>
                    <div *ngIf="segmentJob()!.revoked">
                      {{
                        'adminUi.couponsV2.bulk.resultRevoked'
                          | translate: { count: segmentJob()!.revoked }
                      }}
                    </div>
                    <div *ngIf="segmentJob()!.already_revoked">
                      {{
                        'adminUi.couponsV2.bulk.resultAlreadyRevoked'
                          | translate: { count: segmentJob()!.already_revoked }
                      }}
                    </div>
                    <div *ngIf="segmentJob()!.not_assigned">
                      {{
                        'adminUi.couponsV2.bulk.resultNotAssigned'
                          | translate: { count: segmentJob()!.not_assigned }
                      }}
                    </div>
                    <div
                      *ngIf="segmentJob()!.error_message"
                ...
                >
                  <div class="flex items-center justify-between gap-3">
                    <div class="font-semibold text-slate-900 dark:text-slate-50">
                      {{ 'adminUi.couponsV2.bulk.segment.jobsTitle' | translate }}
                    </div>
                    <app-button
                      size="xs"
                      variant="ghost"
                  ...
                  <div
                    *ngIf="segmentJobsError()"
                    class="mt-2 text-xs text-rose-700 dark:text-rose-200"
                  >
                    {{ segmentJobsError() }}
                  </div>
                  <div
                    *ngIf="segmentJobsLoading()"
                    class="mt-2 text-sm text-slate-600 dark:text-slate-300"
                  >
                    {{ 'adminUi.couponsV2.bulk.segment.jobsLoading' | translate }}
                  </div>
                  <div
                    *ngIf="!segmentJobsLoading() && segmentJobs().length === 0"
                    class="mt-2 text-sm text-slate-600 dark:text-slate-300"
                  >
                    ...
                    <div class="flex items-start justify-between gap-3">
                      <div class="grid gap-1">
                        ...
                        <div class="text-xs text-slate-600 dark:text-slate-300">
                          {{
                            'adminUi.couponsV2.bulk.segment.jobProgress'
                              | translate: { processed: j.processed, total: j.total_candidates }
                          }}
                        </div>
                        <div
                          *ngIf="j.action === 'assign'"
                        ...
                        >
                          ...
                          {{
                            'adminUi.couponsV2.bulk.resultRestored'
                              | translate: { count: j.restored }
                          }}
                          ·
                          {{
                            'adminUi.couponsV2.bulk.resultAlreadyActive'
                              | translate: { count: j.already_active }
                          }}
                        </div>
                        <div
                          *ngIf="j.action === 'revoke'"
                          class="text-xs text-slate-600 dark:text-slate-300"
                        >
                          {{
                          ...
                          {{
                            'adminUi.couponsV2.bulk.resultAlreadyRevoked'
                              | translate: { count: j.already_revoked }
                          }}
                          ·
                          {{
                            'adminUi.couponsV2.bulk.resultNotAssigned'
                              | translate: { count: j.not_assigned }
                          }}
                        </div>
                        <div
                          *ngIf="j.error_message"
                          class="text-xs text-rose-700 dark:text-rose-200"
                        >
                          {{ j.error_message }}
                        </div>
            ...
            <div class="rounded-xl border border-slate-200 p-3 grid gap-3 dark:border-slate-800">
              <div class="grid gap-1">
                <div class="text-sm font-semibold text-slate-900 dark:text-slate-50">
                  {{ 'adminUi.couponsV2.ab.title' | translate }}
                </div>
                <p class="text-sm text-slate-600 dark:text-slate-300">
                  {{ 'adminUi.couponsV2.ab.hint' | translate }}
                </p>
              </div>

              <div
                *ngIf="!abCanRun()"
                class="text-sm text-amber-800 bg-amber-50 border border-amber-200 rounded-lg p-3 dark:bg-amber-950/30 dark:text-amber-100 dark:border-amber-900/40"
              >
              ...
              <div class="grid gap-3 lg:grid-cols-[1fr_auto] items-end">
                <app-input
                  [label]="'adminUi.couponsV2.ab.couponB' | translate"
                  [(value)]="abCouponQuery"
                ></app-input>
                <app-button
                  size="sm"
                  variant="ghost"
                  [label]="'adminUi.actions.search' | translate"
                  (action)="abSearchCoupons()"
                ></app-button>
              </div>

              <div *ngIf="abCouponError()" class="text-sm text-rose-700 dark:text-rose-200">
                {{ abCouponError() }}
              </div>
              <div *ngIf="abCouponLoading()" class="text-sm text-slate-600 dark:text-slate-300">
                {{ 'adminUi.couponsV2.ab.searching' | translate }}
              </div>

              <div
                *ngIf="abCouponResults().length"
                class="rounded-lg border border-slate-200 bg-white text-sm dark:border-slate-800 dark:bg-slate-900"
              >
                <button
                ...
                >
                  ...
                  <div class="text-xs text-slate-500 dark:text-slate-400">
                    {{ c.promotion?.name || c.promotion_id }}
                  </div>
                </button>
              </div>
              ...
              >
                <div class="font-semibold text-slate-900 dark:text-slate-50">
                  {{ 'adminUi.couponsV2.ab.selectedB' | translate }}
                </div>
                <div class="mt-1">
                  <span class="font-semibold">{{ abCouponB()!.code }}</span>
                  <span class="text-slate-500 dark:text-slate-400"
                    >· {{ abCouponB()!.promotion?.name || abCouponB()!.promotion_id }}</span
                  >
                </div>
                <div
                  *ngIf="abCouponB()!.visibility !== 'assigned'"
              ...
              <div class="grid gap-2 lg:grid-cols-2">
                ...
                >
                  <input
                    type="checkbox"
                    class="h-5 w-5 accent-indigo-600"
                    [(ngModel)]="abRequireMarketingOptIn"
                  />
                  {{ 'adminUi.couponsV2.bulk.segment.filterMarketing' | translate }}
                </label>
                <label
                ...
                >
                  <input
                    type="checkbox"
                    class="h-5 w-5 accent-indigo-600"
                    [(ngModel)]="abRequireEmailVerified"
                  />
                  {{ 'adminUi.couponsV2.bulk.segment.filterVerified' | translate }}
                </label>
              </div>
              ...
              <div class="grid gap-3 lg:grid-cols-[1fr_auto] items-end">
                <app-input
                  [label]="'adminUi.couponsV2.ab.seed' | translate"
                  [(value)]="abBucketSeed"
                ></app-input>
                <app-button
                  size="sm"
                      ...
                      <div class="text-xs text-slate-500 dark:text-slate-400">
                        {{
                          'adminUi.couponsV2.bulk.segment.jobProgress'
                            | translate
                              : {
                                  processed: abJobA()!.processed,
                                  total: abJobA()!.total_candidates,
                                }
                        }}
                      </div>
                    </div>
                      ...
                      <div class="text-xs text-slate-500 dark:text-slate-400">
                        {{
                          'adminUi.couponsV2.bulk.segment.jobProgress'
                            | translate
                              : {
                                  processed: abJobB()!.processed,
                                  total: abJobB()!.total_candidates,
                                }
                        }}
                      </div>
                    </div>
              ...
              <div class="flex flex-wrap items-center justify-between gap-3">
                ...
                <app-button
                  ...
                  [disabled]="!abCouponB()"
                  [label]="'adminUi.actions.refresh' | translate"
                  (action)="loadAbAnalytics()"
                ></app-button>
              </div>

              <div *ngIf="abAnalyticsError()" class="text-sm text-rose-700 dark:text-rose-200">
                {{ abAnalyticsError() }}
              </div>
              <div *ngIf="abAnalyticsLoading()" class="text-sm text-slate-600 dark:text-slate-300">
                {{ 'adminUi.couponsV2.ab.loading' | translate }}
              </div>

              <div *ngIf="abAnalyticsA() && abAnalyticsB()" class="grid gap-3 lg:grid-cols-2">
                <div
                  class="rounded-lg border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950/40"
                >
                  <div class="text-sm font-semibold text-slate-900 dark:text-slate-50">
                    {{ selectedCoupon()!.code }} · A
                  </div>
                  <div class="mt-2 grid gap-1 text-sm text-slate-700 dark:text-slate-200">
                    <div>
                      {{ 'adminUi.couponsV2.analytics.summary.redemptions' | translate }}:
                      {{ abAnalyticsA()!.summary.redemptions }}
                    </div>
                    <div>
                      {{ 'adminUi.couponsV2.analytics.summary.totalDiscount' | translate }}:
                      {{ formatRonString(abAnalyticsA()!.summary.total_discount_ron) }}
                    </div>
                    <div>
                      {{ 'adminUi.couponsV2.analytics.summary.lift' | translate }}:
                      {{ formatRonString(abAnalyticsA()!.summary.aov_lift) }}
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div class="mt-2 grid gap-1 text-sm text-slate-700 dark:text-slate-200">
                    <div>
                      {{ 'adminUi.couponsV2.analytics.summary.redemptions' | translate }}:
                      {{ abAnalyticsB()!.summary.redemptions }}
                    </div>
                    <div>
                      {{ 'adminUi.couponsV2.analytics.summary.totalDiscount' | translate }}:
                      {{ formatRonString(abAnalyticsB()!.summary.total_discount_ron) }}
                    </div>
                    <div>
                      {{ 'adminUi.couponsV2.analytics.summary.lift' | translate }}:
                      {{ formatRonString(abAnalyticsB()!.summary.aov_lift) }}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div
              *ngIf="!assignmentsLoading() && assignments().length === 0"
              class="text-sm text-slate-600 dark:text-slate-300"
            >
            ...
            <div
              *ngIf="!assignmentsLoading() && assignments().length"
              class="overflow-x-auto rounded-xl border border-slate-200 dark:border-slate-800"
            >
              <table class="min-w-[780px] w-full text-sm">
                <thead class="bg-slate-50 text-slate-700 dark:bg-slate-800/70 dark:text-slate-200">
                  <tr>
                    <th class="text-left font-semibold px-3 py-2">
                      {{ 'adminUi.couponsV2.assignments.table.user' | translate }}
                    </th>
                    <th class="text-left font-semibold px-3 py-2">
                      {{ 'adminUi.couponsV2.assignments.table.issued' | translate }}
                    </th>
                    <th class="text-left font-semibold px-3 py-2">
                      {{ 'adminUi.couponsV2.assignments.table.status' | translate }}
                    </th>
                    <th class="text-left font-semibold px-3 py-2">
                      {{ 'adminUi.couponsV2.assignments.table.reason' | translate }}
                    </th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  >
                    ...
                    <td class="px-3 py-2">
                      ...
                      >
                        {{
                          a.revoked_at
                            ? ('adminUi.couponsV2.assignments.revoked' | translate)
                            : ('adminUi.couponsV2.assignments.active' | translate)
                        }}
                      </span>
                    </td>
                    <td class="px-3 py-2 text-slate-600 dark:text-slate-300">
...
export class AdminCouponsComponent implements OnInit, OnDestroy {
    ...
    this.adminCoupons.listPromotions().subscribe({
      ...
      error: (err) => {
        ...
        this.promotionsError.set(
          err?.error?.detail || this.t('adminUi.couponsV2.errors.loadPromotions'),
        );
      },
    });
  }
  ...
  savePromotion(): void {
    ...
    const op = promoId
      ? this.adminCoupons.updatePromotion(promoId, payload)
      : this.adminCoupons.createPromotion(payload);
    op.subscribe({
      next: (promo) => {
      ...
      error: (err) => {
        this.promotionSaving.set(false);
        this.toast.error(
          this.t('adminUi.couponsV2.errors.savePromotion'),
  ...
  loadAnalytics(): void {
    ...
    const couponId =
      this.analyticsOnlySelectedCoupon && this.selectedCoupon() ? this.selectedCoupon()!.id : null;
      ...
      .subscribe({
        ...
        error: (err) => {
          ...
          this.analyticsError.set(
            err?.error?.detail || this.t('adminUi.couponsV2.errors.loadAnalytics'),
          );
        },
      });
  }
  ...
  startAbTest(): void {
    ...
    if (!this.abCanRun()) {
      this.toast.error(
        this.t('adminUi.couponsV2.errors.validation'),
        this.t('adminUi.couponsV2.ab.requiresAssigned'),
      );
      return;
    }
    ...
    forkJoin({
      ...
      error: (err) => {
        this.abBusy.set(false);
        this.toast.error(
          this.t('adminUi.couponsV2.ab.startError'),
          err?.error?.detail || undefined,
        );
      },
    });
  ...
  loadAbAnalytics(): void {
    ...
    this.abAnalyticsError.set(null);
    forkJoin({
      a: this.adminCoupons.getAnalytics({
        promotion_id: couponA.promotion_id,
        coupon_id: couponA.id,
        days: this.abAnalyticsDays,
      }),
      b: this.adminCoupons.getAnalytics({
        promotion_id: couponB.promotion_id,
  ...
  generateCouponCode(): void {
    ...
    this.adminCoupons.generateCouponCode({ prefix, pattern, length }).subscribe({
      next: (res) => {
        ...
        this.couponForm.code = String(res?.code || '')
          .trim()
          .toUpperCase();
        if (this.couponForm.code)
          this.toast.success(this.t('adminUi.couponsV2.success.codeGenerated'));
      },
      error: (err) => {
        this.couponCodeGenerating.set(false);
        this.toast.error(
          this.t('adminUi.couponsV2.errors.validation'),
          err?.error?.detail || this.t('adminUi.couponsV2.errors.codeGenerate'),
        );
      },
    });
  }
  ...
  saveCoupon(): void {
    ...
    if (!promoId) {
      this.toast.error(
        this.t('adminUi.couponsV2.errors.validation'),
        this.t('adminUi.couponsV2.errors.couponPromotionRequired'),
      );
      return;
    }
    ...
    if (!this.selectedCoupon() && !code) {
      this.toast.error(
        this.t('adminUi.couponsV2.errors.validation'),
        this.t('adminUi.couponsV2.errors.couponCodeRequired'),
      );
      return;
    }
    ...
    const payload: any = {
      ...
      starts_at: this.couponForm.starts_at
        ? new Date(this.couponForm.starts_at).toISOString()
        : null,
    ...
    op.subscribe({
      ...
      error: (err) => {
        this.couponSaving.set(false);
        this.toast.error(
          this.t('adminUi.couponsV2.errors.saveCoupon'),
          err?.error?.detail || undefined,
        );
      },
    });
    ...
    this.adminCoupons.listAssignments(couponId).subscribe({
      ...
      error: (err) => {
        ...
        this.assignmentsError.set(
          err?.error?.detail || this.t('adminUi.couponsV2.errors.loadAssignments'),
        );
      },
    });
  }
  ...
  assign(): void {
    ...
    if (!email) {
      this.toast.error(
        this.t('adminUi.couponsV2.errors.validation'),
        this.t('adminUi.couponsV2.errors.emailRequired'),
      );
      return;
    }
    this.adminCoupons
      .assignCoupon(couponId, { email, send_email: this.assignSendEmail })
      .subscribe({
        next: () => {
        ...
        error: (err) =>
          this.toast.error(
            this.t('adminUi.couponsV2.errors.assign'),
            err?.error?.detail || undefined,
          ),
      });
  }
  ...
  revoke(): void {
    ...
    this.adminCoupons
      ...
      .subscribe({
        ...
        error: (err) =>
          this.toast.error(
            this.t('adminUi.couponsV2.errors.revoke'),
            err?.error?.detail || undefined,
          ),
      });
  }
    ...
    this.adminProducts.search({ q, page: 1, limit: 20 }).subscribe({
      ...
      error: (err) => {
        ...
        this.productsError.set(
          err?.error?.detail || this.t('adminUi.couponsV2.errors.searchProducts'),
        );
      },
    });
  }
  ...
  addScopeProduct(mode: 'include' | 'exclude', product: AdminProductListItem): void {
    ...
    if (mode === 'include') {
      ...
      this.promotionForm.excluded_product_ids = this.promotionForm.excluded_product_ids.filter(
        (x) => x !== id,
      );
    } else {
      ...
      this.promotionForm.included_product_ids = this.promotionForm.included_product_ids.filter(
        (x) => x !== id,
      );
    }
  }
  ...
  describePromotion(promo: PromotionRead): string {
    ...
    if (promo.discount_type === 'free_shipping')
      return this.t('adminUi.couponsV2.discountSummary.freeShipping');
  ...
  promotionScheduleRows(): PromotionScheduleRow[] {
    ...
    for (const row of visible) {
      const leftPct = Math.max(
        0,
        Math.min(100, ((row.visibleStartMs - windowStart) / duration) * 100),
      );
      ...
      const conflictNamesLabel =
        conflictNames.length > preview.length
          ? `${preview.join(', ')} +${conflictNames.length - preview.length}`
          : preview.join(', ');
  ...
  private loadScopedProducts(): void {
    const ids = this.uniqueIds([
      ...this.promotionForm.included_product_ids,
      ...this.promotionForm.excluded_product_ids,
    ]);
  ...
  private validatePromotionForm(): string | null {
    ...
    const starts = this.promotionForm.starts_at
      ? Date.parse(new Date(this.promotionForm.starts_at).toISOString())
      : null;
    const ends = this.promotionForm.ends_at
      ? Date.parse(new Date(this.promotionForm.ends_at).toISOString())
      : null;
    ...
    if (this.promotionForm.discount_type === 'percent') {
      ...
      if (pct === null || pct <= 0 || pct > 100)
        return this.t('adminUi.couponsV2.errors.percentRequired');
    }
  ...
  private promotionPayloadFromForm(): any {
    ...
    return {
      ...
      percentage_off:
        this.promotionForm.discount_type === 'percent'
          ? this.optionalDecimalString(this.promotionForm.percentage_off)
          : null,
      amount_off:
        this.promotionForm.discount_type === 'amount'
          ? this.optionalDecimalString(this.promotionForm.amount_off)
          : null,
      ...
      starts_at: this.promotionForm.starts_at
        ? new Date(this.promotionForm.starts_at).toISOString()
        : null,
      ends_at: this.promotionForm.ends_at
        ? new Date(this.promotionForm.ends_at).toISOString()
        : null,
  ...
  private promotionToForm(promo: PromotionRead): PromotionForm {
    return {
      ...
      included_product_ids: Array.isArray(promo.included_product_ids)
        ? promo.included_product_ids
        : [],
      excluded_product_ids: Array.isArray(promo.excluded_product_ids)
        ? promo.excluded_product_ids
        : [],
      included_category_ids: Array.isArray(promo.included_category_ids)
        ? promo.included_category_ids
        : [],
      excluded_category_ids: Array.isArray(promo.excluded_category_ids)
        ? promo.excluded_category_ids
        : [],
    };
  }
  ...
  stackingPreviewProductDiscount(assumeAllItemsOnSale: boolean): number | null {
    ...
    const eligibleSubtotal =
      assumeAllItemsOnSale && !this.promotionForm.allow_on_sale_items ? 0 : subtotal;
  ...
  bulkAssign(): void {
    ...
    if (emails.length === 0) {
      this.toast.error(
        this.t('adminUi.couponsV2.errors.validation'),
        this.t('adminUi.couponsV2.bulk.noEmails'),
      );
      return;
    }
    ...
    this.adminCoupons
      .bulkAssignCoupon(couponId, { emails, send_email: this.bulkAssignSendEmail })
      .subscribe({
        next: (res) => {
  ...
  bulkRevoke(): void {
    ...
    this.bulkResult.set(null);
    this.adminCoupons
      .bulkRevokeCoupon(couponId, {
        emails,
        reason: reason || null,
        send_email: this.bulkRevokeSendEmail,
      })
      .subscribe({
        next: (res) => {
          this.bulkBusy.set(false);
  ...
  loadSegmentJobs(): void {
    ...
    this.adminCoupons.listBulkJobs(couponId, { limit: 10 }).subscribe({
      ...
      error: (err) => {
        this.segmentJobsLoading.set(false);
        this.segmentJobsError.set(
          err?.error?.detail || this.t('adminUi.couponsV2.bulk.segment.jobsLoadError'),
        );
  ...
  segmentPreview(): void {
    ...
    forkJoin({
      assign: this.adminCoupons.previewSegmentAssign(couponId, {
        ...payloadBase,
      ...
      error: (err) => {
        this.segmentPreviewBusy.set(false);
        this.toast.error(
          this.t('adminUi.couponsV2.bulk.segment.previewError'),
          err?.error?.detail || undefined,
        );
      },
    });
  ...
  cancelSegmentJob(job: CouponBulkJobRead): void {
    ...
    this.adminCoupons.cancelBulkJob(job.id).subscribe({
      ...
      error: (err) => {
        this.segmentJobsBusy.set(false);
        this.toast.error(
          this.t('adminUi.couponsV2.bulk.segment.cancelError'),
          err?.error?.detail || undefined,
        );
      },
    });
  ...
  retrySegmentJob(job: CouponBulkJobRead): void {
    ...
    this.adminCoupons.retryBulkJob(job.id).subscribe({
      ...
      error: (err) => {
        this.segmentJobsBusy.set(false);
        this.toast.error(
          this.t('adminUi.couponsV2.bulk.segment.retryError'),
          err?.error?.detail || undefined,
        );
      },
    });
  ...
  private parseEmailsFromCsv(text: string): {
    emails: string[];
    invalid: string[];
    duplicates: number;
    truncated: number;
