This Privacy Policy explains how IONITA M.D. ADRIANA PFA (“we”, “us”, “our”) collects, uses, and shares personal data when you visit momentstudio.ro or purchase from us.

This document is provided for transparency and to help you understand your rights under data protection laws (including the GDPR).
...
- email address,
- phone number,
- login identifiers and encrypted credentials,
...
1. **Creating and managing your account** (contract performance / legitimate interests).
2. **Processing orders and delivering Products** (contract performance).
3. **Payments and fraud prevention** (contract performance, legal obligations, legitimate interests).
4. **Customer support and complaint handling** (contract performance, legitimate interests, legal obligations).
5. **Accounting and tax compliance** (legal obligations).
6. **Security of the Website** (legitimate interests).
7. **Marketing communications** (only if you consent or where legally permitted).
...
We share your data only as needed, for example with:

- **Payment processors:** NETOPIA Payments and/or other enabled processors (PayPal/Stripe) – for payment processing and confirmation.
- **Couriers / delivery providers:** Sameday/FanCourier – to ship your order (name, phone, delivery address).
- **Email/SMS providers:** Mailtrap – to send transactional messages (order confirmation, delivery updates).
- **Hosting / infrastructure providers:** chroot.ro – to host the Website and databases.
- **Security/anti-bot tools:** Cloudflare Turnstile (if enabled on login/registration) – to prevent abuse.
...
- **security logs:** Until you delete your account or request deletion.
...
No online system is 100% secure; please contact us if you suspect unauthorized access to your account.
...
The Website is not intended for children under 18. If you believe a child provided personal data, contact us and we will take appropriate steps.

---

## 12) Changes to this Privacy Policy

We may update this policy from time to time. The latest version will be posted on the Website with an updated date.
