...
/** Golden WU admin-support-cmp-show-templates -- showTemplates. */
describe('AdminSupportComponent showTemplates (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).showTemplates(); }).not.toThrow();
  });
});
