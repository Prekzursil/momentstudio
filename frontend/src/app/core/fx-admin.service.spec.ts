...
function expectFetchAdminStatus(service: FxAdminService, httpMock: HttpTestingController): void {
...
function expectSetAndClearOverride(service: FxAdminService, httpMock: HttpTestingController): void {
...
describe('FxAdminService', () => {
  ...
  it('fetches admin status', () => {
    expectFetchAdminStatus(service, httpMock);
  });

  it('sets and clears override', () => {
    expectSetAndClearOverride(service, httpMock);
  });
});
