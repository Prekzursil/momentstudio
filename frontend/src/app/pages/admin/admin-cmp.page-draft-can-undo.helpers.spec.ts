...
/** Golden WU admin-cmp-page-draft-can-undo -- pageDraftCanUndo. */
describe('AdminComponent pageDraftCanUndo (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).pageDraftCanUndo(undefined as any); }).not.toThrow();
  });
});
