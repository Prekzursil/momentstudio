...
/** Golden WU checkout-shipping-step-cmp-courier-estimate-params -- courierEstimateParams. */
describe('CheckoutShippingStepComponent courierEstimateParams (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).courierEstimateParams(undefined as any); }).not.toThrow();
  });
});
