...
def upgrade() -> None:
    op.add_column(
        "content_images",
        sa.Column("root_image_id", postgresql.UUID(as_uuid=True), nullable=True),
    )
    op.add_column(
        "content_images",
    ...
    op.create_index(
        op.f("ix_content_images_root_image_id"),
        "content_images",
        ["root_image_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_content_images_source_image_id"),
        "content_images",
        ["source_image_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_content_images_source_image_id"), table_name="content_images"
    )
