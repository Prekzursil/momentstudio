...
/** Golden WU checkout-shipping-step-cmp-apply-selected-billing-address -- applySelectedBillingAddress. */
describe('CheckoutShippingStepComponent applySelectedBillingAddress (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).applySelectedBillingAddress(); }).not.toThrow();
  });
});
