...
/** Golden WU account-state-revoke-receipt-share -- revokeReceiptShare. */
describe('AccountState revokeReceiptShare (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).revokeReceiptShare(undefined as any); }).not.toThrow();
  });
});
