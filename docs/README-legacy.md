...
> Archived legacy README (kept for historical reference). See `README.md` for current instructions.
...
# edit DATABASE_URL, SECRET_KEY, STRIPE_ENV/STRIPE_SECRET_KEY_SANDBOX, SMTP_*
