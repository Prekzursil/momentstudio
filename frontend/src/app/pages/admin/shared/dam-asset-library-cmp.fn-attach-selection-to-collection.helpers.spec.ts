...
/** Golden WU dam-asset-library-cmp-fn-attach-selection-to-collection -- attachSelectionToCollection. */
describe('DamAssetLibraryComponent attachSelectionToCollection (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).attachSelectionToCollection(undefined as any); }).not.toThrow();
  });
});
