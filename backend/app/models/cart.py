...
class Cart(Base):
    ...
    guest_email_verification_token: Mapped[str | None] = mapped_column(String(64), nullable=True)
    guest_email_verification_expires_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    guest_email_verified_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    guest_email_verification_attempts: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    guest_email_verification_last_attempt_at: Mapped[datetime | None] = mapped_column(
