...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "discount_ron", sa.Numeric(10, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "shipping_discount_ron",
            sa.Numeric(10, 2),
            nullable=False,
            server_default="0",
        ),
    ...
    op.create_index(
        op.f("ix_coupon_reservations_expires_at"),
        "coupon_reservations",
        ["expires_at"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_coupon_reservations_expires_at"), table_name="coupon_reservations"
    )
