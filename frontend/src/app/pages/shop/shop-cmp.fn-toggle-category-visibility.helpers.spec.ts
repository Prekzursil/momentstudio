...
/** Golden WU shop-cmp-fn-toggle-category-visibility -- toggleCategoryVisibility. */
describe('ShopComponent toggleCategoryVisibility (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleCategoryVisibility({} as any, undefined as any); }).not.toThrow();
  });
});
