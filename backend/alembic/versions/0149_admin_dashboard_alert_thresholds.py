...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "key", sa.String(length=50), nullable=False, server_default="default"
        ),
        sa.Column(
            "failed_payments_min_count",
            sa.Integer(),
            nullable=False,
            server_default="1",
        ),
        ...
        sa.Column(
            "stockouts_min_count", sa.Integer(), nullable=False, server_default="1"
        ),
        sa.Column(
            "created_at",
...
def downgrade() -> None:
    op.drop_index(
        "ix_admin_dashboard_alert_thresholds_key",
        table_name="admin_dashboard_alert_thresholds",
    )
