  ...
  template: `
    ...
    >
      <div class="flex items-center justify-between gap-3">
        <p
          class="text-sm font-semibold text-slate-800 uppercase tracking-[0.2em] dark:text-slate-200"
        >
          {{ 'checkout.step1' | translate }}
        </p>
        <span
          *ngIf="step1Complete()"
        ...
        <div class="grid gap-1 text-sm">
          ...
          <div class="grid grid-cols-[1fr_auto] gap-2 items-center">
            ...
            <app-button
              size="sm"
              variant="ghost"
              [label]="guestShowPassword ? ('auth.hide' | translate) : ('auth.show' | translate)"
              (action)="toggleGuestPassword()"
            ></app-button>
          </div>
          <span class="text-xs text-slate-500 dark:text-slate-400">{{
        ...
        <div class="grid gap-1 text-sm">
          ...
          <div class="grid grid-cols-[1fr_auto] gap-2 items-center">
            ...
            <app-button
              ...
              variant="ghost"
              [label]="
                guestShowPasswordConfirm ? ('auth.hide' | translate) : ('auth.show' | translate)
              "
              (action)="toggleGuestPasswordConfirm()"
            ></app-button>
          </div>
          <span
            *ngIf="guestPasswordConfirm && guestPasswordConfirm !== guestPassword"
        ...
        <div class="grid gap-1 text-sm sm:col-span-2">
          ...
          <div class="grid grid-cols-1 gap-2 sm:grid-cols-[minmax(0,220px)_minmax(0,1fr)]">
            <select
              ...
              required
            >
              <option *ngFor="let c of phoneCountries" [value]="c.code">
            ...
            <input
              ...
              [ngClass]="
                (guestPhoneCtrl.invalid && (guestPhoneCtrl.touched || checkoutForm.submitted)) ||
          ...
          <span
            *ngIf="
              guestPhoneCtrl.invalid &&
              guestPhoneCtrl.errors?.['required'] &&
              (guestPhoneCtrl.touched || checkoutForm.submitted)
            "
    ...
    >
      ...
      <div class="grid sm:grid-cols-2 gap-3">
        <label class="text-sm grid gap-1">
          ...
          <input
            ...
            "
            [attr.aria-invalid]="
              nameCtrl.invalid && (nameCtrl.touched || checkoutForm.submitted) ? 'true' : null
            "
        ...
        <label class="text-sm grid gap-1">
          ...
          <input
            ...
            "
            [attr.aria-invalid]="
              emailCtrl.invalid && (emailCtrl.touched || checkoutForm.submitted) ? 'true' : null
            "
          ...
          <div *ngIf="!auth.isAuthenticated()" class="flex flex-wrap items-center gap-2">
            ...
            ></app-button>
            <span
              *ngIf="guestEmailVerified"
              class="text-xs font-medium text-emerald-700 dark:text-emerald-300"
              >✓</span
            >
            <span
              *ngIf="!guestEmailVerified && guestResendSecondsLeft > 0"
          ...
          <div
            *ngIf="!auth.isAuthenticated() && guestVerificationSent && !guestEmailVerified"
            class="grid gap-2"
          >
            <p class="text-xs text-slate-600 dark:text-slate-300">
              {{ 'checkout.emailVerifyLinkSent' | translate }}
            </p>
            <p *ngIf="guestEmailError" class="text-xs text-amber-700 dark:text-amber-300">
              {{ guestEmailError }}
            </p>
          </div>
        </label>
        <div *ngIf="shippingPhoneRequired()" class="grid gap-1 text-sm sm:col-span-2">
          ...
          <div class="grid grid-cols-1 gap-2 sm:grid-cols-[minmax(0,220px)_minmax(0,1fr)]">
            ...
            <input
              ...
              class="w-full min-w-0 rounded-lg border bg-white px-3 py-2 text-slate-900 shadow-sm dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-400"
              [ngClass]="
                (shippingPhoneCtrl.invalid &&
                  (shippingPhoneCtrl.touched || checkoutForm.submitted)) ||
                (shippingPhoneNational && !shippingPhoneE164())
                  ? 'border-rose-300 ring-2 ring-rose-200 dark:border-rose-900/40 dark:ring-rose-900/30'
                  : 'border-slate-200 dark:border-slate-700'
              "
              [attr.aria-invalid]="
          ...
          <span
            *ngIf="
              shippingPhoneCtrl.invalid && (shippingPhoneCtrl.touched || checkoutForm.submitted)
            "
        ...
        <ng-container *ngIf="auth.isAuthenticated()">
          <div class="sm:col-span-2 flex items-center justify-between gap-2">
            ...
            <a
              ...
              >{{ 'checkout.manageAddresses' | translate }}</a
            >
          </div>
          <div
            *ngIf="savedAddressesLoading"
            class="sm:col-span-2 text-xs text-slate-600 dark:text-slate-300"
          >
            {{ 'notifications.loading' | translate }}
          </div>
          <p
            *ngIf="savedAddressesError"
            class="sm:col-span-2 text-xs text-rose-700 dark:text-rose-300"
          >
            {{ savedAddressesError }}
          </p>
        ...
        <label class="text-sm grid gap-1 sm:col-span-2">
          ...
          <input
            ...
            "
            [attr.aria-invalid]="
              line1Ctrl.invalid && (line1Ctrl.touched || checkoutForm.submitted) ? 'true' : null
            "
        ...
        <div class="grid gap-3 sm:grid-cols-3 sm:col-span-2">
          <label class="text-sm grid gap-1">
            ...
            <input
              ...
              "
              [attr.aria-invalid]="
                cityCtrl.invalid && (cityCtrl.touched || checkoutForm.submitted) ? 'true' : null
              "
          ...
          <label class="text-sm grid gap-1">
            ...
            <input
              ...
              "
              [attr.aria-invalid]="
                regionCtrl.invalid && (regionCtrl.touched || checkoutForm.submitted) ? 'true' : null
              "
          ...
          <label class="text-sm grid gap-1">
            ...
            <input
              ...
              "
              [attr.aria-invalid]="
                postalCtrl.invalid && (postalCtrl.touched || checkoutForm.submitted) ? 'true' : null
              "
        ...
        <label class="text-sm grid gap-1 sm:col-span-2">
          ...
          <input
            ...
            [ngClass]="
              ...
              (shippingCountryCtrl.invalid &&
                (shippingCountryCtrl.touched || checkoutForm.submitted))
                ? 'border-rose-300 ring-2 ring-rose-200 dark:border-rose-900/40 dark:ring-rose-900/30'
                : 'border-slate-200 dark:border-slate-700'
            "
            [attr.aria-invalid]="
          ...
          <span
            *ngIf="
              shippingCountryCtrl.invalid && (shippingCountryCtrl.touched || checkoutForm.submitted)
            "
          ...
          <span
            *ngIf="shippingCountryError"
            id="checkout-shipping-country-invalid"
            class="text-xs font-normal text-rose-700 dark:text-rose-300"
            >{{ shippingCountryError }}</span
          >
        </label>
      </div>
      ...
      <div class="grid gap-3 border-t border-slate-200 pt-4 dark:border-slate-800">
              ...
              >
                <div class="flex items-start justify-between gap-3">
                  <div class="min-w-0">
                    ...
                    <p
                      *ngIf="courierEstimateKey('sameday')"
                  ...
                  <p class="text-xs text-slate-600 dark:text-slate-300">
                    ...
                    {{ quoteShipping() | localizedCurrency: currency }}
                  </p>
                </div>
              </button>
              <button
              ...
              >
                <div class="flex items-start justify-between gap-3">
                  <div class="min-w-0">
                    ...
                    <p
                      *ngIf="courierEstimateKey('fan_courier')"
                      class="text-xs text-slate-600 dark:text-slate-300"
                    >
                      {{
                        courierEstimateKey('fan_courier')
                          | translate: courierEstimateParams('fan_courier')
                      }}
                    </p>
                  </div>
                  <p class="text-xs text-slate-600 dark:text-slate-300">
        ...
        <div
          *ngIf="deliveryType === 'locker'"
          id="checkout-locker-picker"
          tabindex="-1"
          class="grid gap-2"
        >
          <app-locker-picker [provider]="courier" [(selected)]="locker"></app-locker-picker>
          <p *ngIf="deliveryError" class="text-xs text-amber-700 dark:text-amber-300">
            {{ deliveryError }}
          </p>
        </div>
      </div>
        ...
        >
          ...
          <div *ngIf="invoiceEnabled" class="grid gap-3 sm:grid-cols-2">
            ...
            <label class="text-sm grid gap-1 sm:col-span-2">
              ...
              />
              <span class="text-xs text-slate-500 dark:text-slate-400">{{
                'checkout.invoiceVatHint' | translate
              }}</span>
            </label>
          </div>
        </div>
        <div *ngIf="!billingSameAsShipping" class="grid sm:grid-cols-2 gap-3">
          ...
          <label class="text-sm grid gap-1 sm:col-span-2">
            ...
            <input
              ...
              [ngClass]="
                billingCountryError ||
                (billingCountryCtrl.invalid &&
                  (billingCountryCtrl.touched || checkoutForm.submitted))
                  ? 'border-rose-300 ring-2 ring-rose-200 dark:border-rose-900/40 dark:ring-rose-900/30'
                  : 'border-slate-200 dark:border-slate-700'
              "
              [attr.aria-invalid]="
            ...
            <span
              *ngIf="
                billingCountryCtrl.invalid && (billingCountryCtrl.touched || checkoutForm.submitted)
              "
            ...
            <span
              *ngIf="billingCountryError"
              id="checkout-billing-country-invalid"
              class="text-xs font-normal text-rose-700 dark:text-rose-300"
              >{{ billingCountryError }}</span
            >
          </label>
        </div>
      </div>
      ...
      <p *ngIf="addressError" class="text-sm text-amber-700 dark:text-amber-300">
        {{ addressError }}
      </p>
      <div class="flex justify-end">
        <app-button
