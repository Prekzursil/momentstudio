...
/** Golden WU admin-cmp-fetch-social-thumbnail -- fetchSocialThumbnail. */
describe('AdminComponent fetchSocialThumbnail (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).fetchSocialThumbnail(undefined as any, 0); }).not.toThrow();
  });
});
