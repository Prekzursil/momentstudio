...
/** Golden WU admin-coupons-cmp-selected-promotion -- selectedPromotion. */
describe('AdminCouponsComponent selectedPromotion (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).selectedPromotion(); }).not.toThrow();
  });
});
