...
/** Golden WU admin-cmp-import-content-redirects -- importContentRedirects. */
describe('AdminComponent importContentRedirects (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).importContentRedirects({} as any); }).not.toThrow();
  });
});
