...
/** Golden WU admin-products-cmp-bulk-status-confirm-busy -- bulkStatusConfirmBusy. */
describe('AdminProductsComponent bulkStatusConfirmBusy (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).bulkStatusConfirmBusy(); }).not.toThrow();
  });
});
