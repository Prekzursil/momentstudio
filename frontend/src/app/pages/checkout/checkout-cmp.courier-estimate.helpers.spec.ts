...
/** Golden WU checkout-cmp-courier-estimate -- courierEstimate. */
describe('CheckoutComponent courierEstimate (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).courierEstimate(undefined as any); }).not.toThrow();
  });
});
