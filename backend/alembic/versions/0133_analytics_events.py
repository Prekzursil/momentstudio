...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_analytics_events_event"), "analytics_events", ["event"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_analytics_events_order_id"),
        "analytics_events",
        ["order_id"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_analytics_events_event_created_at"), table_name="analytics_events"
    )
